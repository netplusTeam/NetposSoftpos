...
object TLVParser {
    ...
    fun extractTrack2DataFromICCResult(
        decryptedIcc: String,
        cardType: String,
    ): String? {
    ...
    private fun findTagValueBefore5A(
        input: String,
        tag: String,
    ): String {
        val tagIndex = input.indexOf(tag)
    ...
    private fun applyTrack2LengthRestriction(
        track2Data: String,
        cardType: String,
    ): String {
