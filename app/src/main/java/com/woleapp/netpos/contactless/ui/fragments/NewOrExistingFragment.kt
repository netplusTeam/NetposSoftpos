...
class NewOrExistingFragment : BaseFragment() {
   ...
   // private lateinit var compositeDisposable:CompositeDisposable
    ...
    private fun initPartnerID() {
        val bankList = mutableMapOf("firstbank" to "7D66B7F7-222B-41CC-A868-185F3A86313F", "fcmb" to "1B0E68FD-7676-4F2C-883D-3931C3564190", "easypay" to "1B0E68FD-7676-4F2C-883D-3931C3564190","fcmbeasypay" to "1B0E68FD-7676-4F2C-883D-3931C3564190",
