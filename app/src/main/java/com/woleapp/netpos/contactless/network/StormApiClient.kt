...
//            loggingInterceptor.level = HttpLoggingInterceptor.Level.BODY
        ...
        private fun getNipOkHttpClient() =
            getBaseOkhttpClientBuilder()
        ...
        fun getInstance(): StormApiService =
        ...
        fun getBillsInstance(): StormApiService =
            BILLS_INSTANCE ?: synchronized(this) {
        ...
        fun getNipInstance(): NipService =
            NIPINSTANCE ?: synchronized(this) {
        ...
        fun getSmsServiceInstance(): SmsService =
            smsServiceInstance ?: synchronized(this) {
...
class BlueCodeInterceptor : Interceptor {
    ...
    private fun getResponseCode(requestUrl: String) =
        when {
