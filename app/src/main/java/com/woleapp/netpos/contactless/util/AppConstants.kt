...
object AppConstants {
    ...
    const val STRING_FIREBASE_NORMAL_APP_NOTIFICATION_CAMPAIGN_INTENT_ACTION = "com.woleapp.netpos.FIREBASE_NORMAL_APP_NOTIFICATION_CAMPAIGN_INTENT_ACTION"
    const val TAG_NOTIFICATION_RECEIVED_FROM_BACKEND = "TAG_NOTIFICATION_RECEIVED_2"
    const val TAG_APP_CAMPAIGN_NOTIFICATION_RECEIVED_FROM_BACKEND = "TAG_APP_CAMPAIGN_NOTIFICATION_RECEIVED_FROM_BACKEND"
    const val INT_FIREBASE_PENDING_INTENT_REQUEST_CODE = 772
    const val NOTIFICATION_ERROR = "NOTIFICATION_ERROR"
    const val DATA_BASE_ERROR_TAG = "DATA_BASE_ERROR_TAG"
    const val WORKER_INPUT_PBT_TRANSACTION_TAG = "WORKER_INPUT_PBT_TRANSACTION_TAG"
    const val WORKER_INPUT_APP_NOTIFICATION_TAG = "WORKER_INPUT_APP_NOTIFICATION_TAG"
    ...
    const val CLICKED_NOTIFICATION_RK = "CLICKED_NOTIFICATION_RK"
    const val CLICKED_NOTIFICATION_BK = "CLICKED_NOTIFICATION_BK"
