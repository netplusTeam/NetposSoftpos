...
import com.woleapp.netpos.databinding.LayoutServiceItemBinding
...
class ServiceAdapter(private val serviceClickListener: ServiceClickListener) :
    ListAdapter<Service, ServiceViewHolder>(ItemDiffUtil) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ServiceViewHolder =
        ServiceViewHolder.from(parent, serviceClickListener)
