...
public class CardReaderService {
    ...
    public static Single<CardReadResult> initiateICCCardPayment(Context context, long amount, long cashBackAmount, GetPin getPin) {
                ...
                public void processResult(int ret) {
                    ...
                    switch (ret) {
                        ...
                        case EmvApi.EMV_TRANS_ACCEPT:
                            updateICCardData(context, EmvApi.EMV_TRANS_ACCEPT, emitter);
                            return;
