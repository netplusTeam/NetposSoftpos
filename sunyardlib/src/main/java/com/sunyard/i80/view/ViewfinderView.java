...
import com.sunyard.i80.camera.CameraManager;
...
/**
 * This com.sunyard.i80demo.com.sunyard.i80demo.zxing.view is overlaid on top of the com.sunyard.i80demo.zxing.camera preview. It adds the viewfinder
...
public final class ViewfinderView extends View {
	...
	public ViewfinderView(Context context, AttributeSet attrs) {
		...
		maskColor = 0;//resources.getColor(R.color.viewfinder_mask);
		resultColor = 0; //resources.getColor(R.color.result_view);
		laserColor = 0;//resources.getColor(R.color.viewfinder_laser);
		resultPointColor = 0;//resources.getColor(R.color.possible_result_points);
		statusColor = 0;//resources.getColor(R.color.status_text);
		scannerAlpha = 0;
		possibleResultPoints = new ArrayList<ResultPoint>(5);
		lastPossibleResultPoints = null;
		scanLight = null;// BitmapFactory.decodeResource(resources, R.mipmap.scan_light);
	}
