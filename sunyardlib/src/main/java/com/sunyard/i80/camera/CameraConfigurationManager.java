...
import com.sunyard.i80.android.PreferencesActivity;
...
final class CameraConfigurationManager {
	...
	/**
	 * Reads, one time, values from the com.sunyard.i80demo.zxing.camera that are needed by the app.
	 */
	@SuppressLint("NewApi")
	...
	void setDesiredCameraParameters(Camera camera, boolean safeMode) {
		...
		if (parameters == null) {
			Log.w(TAG,
					"Device error: no com.sunyard.i80demo.zxing.camera parameters are available. Proceeding without configuration.");
			return;
		}

		Log.i(TAG, "Initial com.sunyard.i80demo.zxing.camera parameters: " + parameters.flatten());

		if (safeMode) {
			Log.w(TAG,
					"In com.sunyard.i80demo.zxing.camera config safe mode -- most settings will not be honored");
		}
		...
		Log.i(TAG, "Final com.sunyard.i80demo.zxing.camera parameters: " + parameters.flatten());
