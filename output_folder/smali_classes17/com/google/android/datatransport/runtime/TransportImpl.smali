...
.method constructor <init>(Lcom/google/android/datatransport/runtime/TransportContext;Ljava/lang/String;Lcom/google/android/datatransport/Encoding;Lcom/google/android/datatransport/Transformer;Lcom/google/android/datatransport/runtime/TransportInternal;)V
    ...
    .param p5, "transportInternal"    # Lcom/google/android/datatransport/runtime/TransportInternal;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 35
    .local p0, "this":Lcom/google/android/datatransport/runtime/TransportImpl;, "Lcom/google/android/datatransport/runtime/TransportImpl<TT;>;"
    .local p4, "transformer":Lcom/google/android/datatransport/Transformer;, "Lcom/google/android/datatransport/Transformer<TT;[B>;"
...
.method public schedule(Lcom/google/android/datatransport/Event;Lcom/google/android/datatransport/TransportScheduleCallback;)V
    ...
    .line 50
    .local p0, "this":Lcom/google/android/datatransport/runtime/TransportImpl;, "Lcom/google/android/datatransport/runtime/TransportImpl<TT;>;"
    .local p1, "event":Lcom/google/android/datatransport/Event;, "Lcom/google/android/datatransport/Event<TT;>;"
    ...
    .line 54
    invoke-virtual {v1, v2}, Lcom/google/android/datatransport/runtime/SendRequest$Builder;->setTransportName(Ljava/lang/String;)Lcom/google/android/datatransport/runtime/SendRequest$Builder;
    ...
    .line 55
    invoke-virtual {v1, v2}, Lcom/google/android/datatransport/runtime/SendRequest$Builder;->setTransformer(Lcom/google/android/datatransport/Transformer;)Lcom/google/android/datatransport/runtime/SendRequest$Builder;

    move-result-object v1

    iget-object v2, p0, Lcom/google/android/datatransport/runtime/TransportImpl;->payloadEncoding:Lcom/google/android/datatransport/Encoding;

    .line 56
    invoke-virtual {v1, v2}, Lcom/google/android/datatransport/runtime/SendRequest$Builder;->setEncoding(Lcom/google/android/datatransport/Encoding;)Lcom/google/android/datatransport/runtime/SendRequest$Builder;

    move-result-object v1

    .line 57
    invoke-virtual {v1}, Lcom/google/android/datatransport/runtime/SendRequest$Builder;->build()Lcom/google/android/datatransport/runtime/SendRequest;

    move-result-object v1

    .line 50
    invoke-interface {v0, v1, p2}, Lcom/google/android/datatransport/runtime/TransportInternal;->send(Lcom/google/android/datatransport/runtime/SendRequest;Lcom/google/android/datatransport/TransportScheduleCallback;)V
