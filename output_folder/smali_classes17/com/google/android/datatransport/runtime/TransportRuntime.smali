...
.method constructor <init>(Lcom/google/android/datatransport/runtime/time/Clock;Lcom/google/android/datatransport/runtime/time/Clock;Lcom/google/android/datatransport/runtime/scheduling/Scheduler;Lcom/google/android/datatransport/runtime/scheduling/jobscheduling/Uploader;Lcom/google/android/datatransport/runtime/scheduling/jobscheduling/WorkInitializer;)V
    .locals 0
    .param p1, "eventClock"    # Lcom/google/android/datatransport/runtime/time/Clock;
    .param p2, "uptimeClock"    # Lcom/google/android/datatransport/runtime/time/Clock;
    .param p3, "scheduler"    # Lcom/google/android/datatransport/runtime/scheduling/Scheduler;
    .param p4, "uploader"    # Lcom/google/android/datatransport/runtime/scheduling/jobscheduling/Uploader;
    .param p5, "initializer"    # Lcom/google/android/datatransport/runtime/scheduling/jobscheduling/WorkInitializer;
...
.method private convert(Lcom/google/android/datatransport/runtime/SendRequest;)Lcom/google/android/datatransport/runtime/EventInternal;
    .locals 4
    .param p1, "request"    # Lcom/google/android/datatransport/runtime/SendRequest;
...
.method public static getInstance()Lcom/google/android/datatransport/runtime/TransportRuntime;
    ...
    .line 92
    .local v0, "localRef":Lcom/google/android/datatransport/runtime/TransportRuntimeComponent;
    if-eqz v0, :cond_0
...
.method private static getSupportedEncodings(Lcom/google/android/datatransport/runtime/Destination;)Ljava/util/Set;
    .locals 2
    .param p0, "destination"    # Lcom/google/android/datatransport/runtime/Destination;
    ...
    check-cast v0, Lcom/google/android/datatransport/runtime/EncodedDestination;

    .line 139
    .local v0, "encodedDestination":Lcom/google/android/datatransport/runtime/EncodedDestination;
    invoke-interface {v0}, Lcom/google/android/datatransport/runtime/EncodedDestination;->getSupportedEncodings()Ljava/util/Set;
    ...
    .line 141
    .end local v0    # "encodedDestination":Lcom/google/android/datatransport/runtime/EncodedDestination;
    :cond_0
...
.method public static initialize(Landroid/content/Context;)V
    ...
    .line 78
    invoke-interface {v1}, Lcom/google/android/datatransport/runtime/TransportRuntimeComponent$Builder;->build()Lcom/google/android/datatransport/runtime/TransportRuntimeComponent;
...
.method static withInstance(Lcom/google/android/datatransport/runtime/TransportRuntimeComponent;Ljava/util/concurrent/Callable;)V
    .locals 3
    .param p0, "component"    # Lcom/google/android/datatransport/runtime/TransportRuntimeComponent;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 105
    .local v1, "original":Lcom/google/android/datatransport/runtime/TransportRuntimeComponent;
    ...
    .line 106
    .end local v1    # "original":Lcom/google/android/datatransport/runtime/TransportRuntimeComponent;
    :catchall_3
    move-exception v1
...
.method public newFactory(Lcom/google/android/datatransport/runtime/Destination;)Lcom/google/android/datatransport/TransportFactory;
    .locals 4
    .param p1, "destination"    # Lcom/google/android/datatransport/runtime/Destination;
    ...
    invoke-virtual {v2, v3}, Lcom/google/android/datatransport/runtime/TransportContext$Builder;->setExtras([B)Lcom/google/android/datatransport/runtime/TransportContext$Builder;
    ...
    invoke-direct {v0, v1, v2, p0}, Lcom/google/android/datatransport/runtime/TransportFactoryImpl;-><init>(Ljava/util/Set;Lcom/google/android/datatransport/runtime/TransportContext;Lcom/google/android/datatransport/runtime/TransportInternal;)V
...
.method public send(Lcom/google/android/datatransport/runtime/SendRequest;Lcom/google/android/datatransport/TransportScheduleCallback;)V
    ...
    .line 151
    invoke-interface {v0, v1, v2, p2}, Lcom/google/android/datatransport/runtime/scheduling/Scheduler;->schedule(Lcom/google/android/datatransport/runtime/TransportContext;Lcom/google/android/datatransport/runtime/EventInternal;Lcom/google/android/datatransport/TransportScheduleCallback;)V
