...
.method static fromXyzInViewingConditions(DDDLcom/google/android/material/color/utilities/ViewingConditions;)Lcom/google/android/material/color/utilities/Cam16;
    ...
    const-wide v50, 0x400e666666666666L    # 3.8
    ...
    .line 280
    .local v0, "t":D
    const-wide v48, 0x3ffa3d70a3d70a3dL    # 1.64
    ...
    mul-double v53, v53, v2

    invoke-virtual/range {p6 .. p6}, Lcom/google/android/material/color/utilities/ViewingConditions;->getAw()D

    move-result-wide v57

    add-double v57, v57, v46

    div-double v53, v53, v57
    ...
    const-wide v53, 0x3f7cac083126e979L    # 0.007

    mul-double v53, v53, v4

    add-double v53, v53, v51

    div-double v83, v46, v53

    .local v83, "jstar":D
    move-wide/from16 v59, v83

    .line 290
    const-wide v46, 0x4045ee08fb823ee0L    # 43.859649122807014

    const-wide v51, 0x3f9758e219652bd4L    # 0.0228

    mul-double v51, v51, v17

    invoke-static/range {v51 .. v52}, Ljava/lang/Math;->log1p(D)D

    move-result-wide v51

    mul-double v85, v51, v46
