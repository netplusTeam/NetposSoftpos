...
.method public constructor <init>(Lch/qos/logback/core/net/server/ServerListener;Ljava/util/concurrent/Executor;)V
    ...
    .line 67
    .local p0, "this":Lch/qos/logback/core/net/server/ConcurrentServerRunner;, "Lch/qos/logback/core/net/server/ConcurrentServerRunner<TT;>;"
    .local p1, "listener":Lch/qos/logback/core/net/server/ServerListener;, "Lch/qos/logback/core/net/server/ServerListener<TT;>;"
...
.method static synthetic access$000(Lch/qos/logback/core/net/server/ConcurrentServerRunner;Lch/qos/logback/core/net/server/Client;)V
    .locals 0
    .param p0, "x0"    # Lch/qos/logback/core/net/server/ConcurrentServerRunner;
    .param p1, "x1"    # Lch/qos/logback/core/net/server/Client;
...
.method private addClient(Lch/qos/logback/core/net/server/Client;)V
    ...
    .line 173
    .local p0, "this":Lch/qos/logback/core/net/server/ConcurrentServerRunner;, "Lch/qos/logback/core/net/server/ConcurrentServerRunner<TT;>;"
    .local p1, "client":Lch/qos/logback/core/net/server/Client;, "TT;"
...
.method private copyClients()Ljava/util/Collection;
    ...
    .line 118
    .local v0, "copy":Ljava/util/Collection;, "Ljava/util/Collection<TT;>;"
    nop
    ...
    .end local v0    # "copy":Ljava/util/Collection;, "Ljava/util/Collection<TT;>;"
    :catchall_0
    move-exception v0
...
.method public accept(Lch/qos/logback/core/net/server/ClientVisitor;)V
    ...
    .line 99
    .local p0, "this":Lch/qos/logback/core/net/server/ConcurrentServerRunner;, "Lch/qos/logback/core/net/server/ConcurrentServerRunner<TT;>;"
    .local p1, "visitor":Lch/qos/logback/core/net/server/ClientVisitor;, "Lch/qos/logback/core/net/server/ClientVisitor<TT;>;"
    invoke-direct {p0}, Lch/qos/logback/core/net/server/ConcurrentServerRunner;->copyClients()Ljava/util/Collection;

    move-result-object v0

    .line 100
    .local v0, "clients":Ljava/util/Collection;, "Ljava/util/Collection<TT;>;"
    ...
    check-cast v2, Lch/qos/logback/core/net/server/Client;

    .line 102
    .local v2, "client":Lch/qos/logback/core/net/server/Client;, "TT;"
    :try_start_0
    invoke-interface {p1, v2}, Lch/qos/logback/core/net/server/ClientVisitor;->visit(Lch/qos/logback/core/net/server/Client;)V
    :try_end_0
    ...
    invoke-virtual {p0, v4}, Lch/qos/logback/core/net/server/ConcurrentServerRunner;->addError(Ljava/lang/String;)V

    .line 106
    .end local v2    # "client":Lch/qos/logback/core/net/server/Client;, "TT;"
...
.method public run()V
    ...
    .line 133
    .local v0, "client":Lch/qos/logback/core/net/server/Client;, "TT;"
    ...
    invoke-virtual {p0, v2}, Lch/qos/logback/core/net/server/ConcurrentServerRunner;->addError(Ljava/lang/String;)V
    ...
    .line 144
    .end local v0    # "client":Lch/qos/logback/core/net/server/Client;, "TT;"
