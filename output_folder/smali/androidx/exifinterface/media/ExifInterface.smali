...
.method private readImageFileDirectory(Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataInputStream;I)V
    ...
    .line 6708
    .local v11, "jpegInterchangeFormatLengthAttribute":Landroidx/exifinterface/media/ExifInterface$ExifAttribute;
    iget-object v14, v0, Landroidx/exifinterface/media/ExifInterface;->mAttributes:[Ljava/util/HashMap;
    ...
    .end local v11    # "jpegInterchangeFormatLengthAttribute":Landroidx/exifinterface/media/ExifInterface$ExifAttribute;
    goto :goto_7
    ...
    .line 6771
    iget-object v13, v0, Landroidx/exifinterface/media/ExifInterface;->mAttributesOffsets:Ljava/util/Set;
    ...
    invoke-direct {v0, v1, v12}, Landroidx/exifinterface/media/ExifInterface;->readImageFileDirectory(Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataInputStream;I)V
    ...
    .line 6808
    invoke-virtual {v12, v5}, Landroidx/exifinterface/media/ExifInterface$ExifAttribute;->getStringValue(Ljava/nio/ByteOrder;)Ljava/lang/String;
    ...
    .line 6810
    invoke-virtual {v12, v5}, Landroidx/exifinterface/media/ExifInterface$ExifAttribute;->getIntValue(Ljava/nio/ByteOrder;)I
    ...
    .local v13, "nextIfdType":Ljava/lang/Integer;
    ...
    .end local v13    # "nextIfdType":Ljava/lang/Integer;
...
.method private savePngAttributes(Ljava/io/InputStream;Ljava/io/OutputStream;)V
    ...
    .line 6300
    iget v3, p0, Landroidx/exifinterface/media/ExifInterface;->mExifOffset:I
...
.method private saveWebpAttributes(Ljava/io/InputStream;Ljava/io/OutputStream;)V
    ...
    .line 6400
    .local v4, "nonHeaderByteArrayOutputStream":Ljava/io/ByteArrayOutputStream;
    :try_start_0
    ...
    invoke-direct {v6, v4, v7}, Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataOutputStream;-><init>(Ljava/io/OutputStream;Ljava/nio/ByteOrder;)V

    .line 6405
    .local v6, "nonHeaderOutputStream":Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataOutputStream;
    ...
    .line 6424
    .local v2, "firstChunkType":[B
    invoke-virtual {v0, v2}, Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataInputStream;->read([B)I
    ...
    .line 6429
    sget-object v3, Landroidx/exifinterface/media/ExifInterface;->WEBP_CHUNK_TYPE_VP8X:[B
    ...
    .line 6443
    .local v9, "containsAnimation":Z
    :goto_1
    invoke-virtual {v6, v3}, Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataOutputStream;->write([B)V

    .line 6444
    invoke-virtual {v6, v7}, Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataOutputStream;->writeInt(I)V

    .line 6445
    invoke-virtual {v6, v8}, Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataOutputStream;->write([B)V
    ...
    invoke-direct {p0, v0, v6, v3, v10}, Landroidx/exifinterface/media/ExifInterface;->copyChunksUpToGivenChunkType(Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataInputStream;Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataOutputStream;[B[B)V
    ...
    .line 6467
    :cond_4
    invoke-direct {p0, v0, v6, v3}, Landroidx/exifinterface/media/ExifInterface;->copyWebPChunk(Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataInputStream;Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataOutputStream;[B)V
    ...
    invoke-direct {p0, v0, v6, v3, v5}, Landroidx/exifinterface/media/ExifInterface;->copyChunksUpToGivenChunkType(Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataInputStream;Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataOutputStream;[B[B)V
    ...
    .end local v7    # "size":I
    .end local v8    # "data":[B
    .end local v9    # "containsAnimation":Z
    :goto_3
    goto :goto_4
    ...
    .line 6494
    .end local v6    # "nonHeaderOutputStream":Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataOutputStream;
    ...
    .line 6478
    .restart local v2    # "firstChunkType":[B
    .restart local v6    # "nonHeaderOutputStream":Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataOutputStream;
    :cond_7
    :try_start_1
    new-instance v3, Ljava/io/IOException;

    const-string v5, "WebP files with only VP8 or VP8L chunks are currently not supported"
    ...
    .end local v4    # "nonHeaderByteArrayOutputStream":Ljava/io/ByteArrayOutputStream;
    ...
    .restart local v4    # "nonHeaderByteArrayOutputStream":Ljava/io/ByteArrayOutputStream;
    .restart local p1    # "inputStream":Ljava/io/InputStream;
    .restart local p2    # "outputStream":Ljava/io/OutputStream;
    :cond_8
    new-instance v3, Ljava/io/IOException;

    const-string v5, "Encountered invalid length while parsing WebP chunk type"
