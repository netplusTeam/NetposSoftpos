...
.method public read(Lokio/Buffer;J)J
    ...
    invoke-virtual {v7}, Lokhttp3/internal/cache2/Relay;->getComplete()Z
    ...
    invoke-virtual {v7}, Lokhttp3/internal/cache2/Relay;->getUpstreamReader()Ljava/lang/Thread;
    ...
    invoke-virtual {v7, v9}, Lokhttp3/internal/cache2/Relay;->setUpstreamReader(Ljava/lang/Thread;)V
    :try_end_2
    ...
    .line 357
    .restart local v0    # "$i$a$-synchronized-Relay$RelaySource$read$2":I
    .restart local v5    # "$this$notifyAll$iv":Ljava/lang/Object;
    .restart local v8    # "$i$f$notifyAll":I
    :cond_6
    :try_start_5
    ...
    invoke-direct {v9, v12}, Ljava/lang/NullPointerException;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v9}, Lokhttp3/internal/cache2/Relay;->getBufferMaxSize()J
    ...
    invoke-virtual {v5, v14, v15}, Lokhttp3/internal/cache2/Relay;->setUpstreamPos(J)V
    ...
    const-string v14, "null cannot be cast to non-null type java.lang.Object"

    invoke-direct {v9, v14}, Ljava/lang/NullPointerException;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v6}, Lokhttp3/internal/cache2/Relay;->setUpstreamReader(Ljava/lang/Thread;)V
