...
.method public final cancelAllAndDecide$okhttp()Z
    ...
    invoke-virtual {v2}, Lokhttp3/internal/concurrent/Task;->getCancelable()Z
    ...
    .local v2, "task$iv":Lokhttp3/internal/concurrent/Task;
    move-object v3, p0

    .local v3, "queue$iv":Lokhttp3/internal/concurrent/TaskQueue;
    const/4 v4, 0x0
    ...
    invoke-static {v2, v3, v5}, Lokhttp3/internal/concurrent/TaskLoggerKt;->access$log(Lokhttp3/internal/concurrent/Task;Lokhttp3/internal/concurrent/TaskQueue;Ljava/lang/String;)V
    ...
    .line 209
    .end local v2    # "task$iv":Lokhttp3/internal/concurrent/Task;
    .end local v3    # "queue$iv":Lokhttp3/internal/concurrent/TaskQueue;
...
.method public final schedule(Lokhttp3/internal/concurrent/Task;J)V
    ...
    .local v2, "queue$iv":Lokhttp3/internal/concurrent/TaskQueue;
    move-object v3, p1
    ...
    .line 65
    .local v5, "$i$a$-taskLog-TaskQueue$schedule$1$1":I
    const-string v6, "schedule canceled (queue is shutdown)"

    .end local v5    # "$i$a$-taskLog-TaskQueue$schedule$1$1":I
    ...
    .end local v2    # "queue$iv":Lokhttp3/internal/concurrent/TaskQueue;
    ...
    .restart local v2    # "queue$iv":Lokhttp3/internal/concurrent/TaskQueue;
    move-object v3, p1

    .restart local v3    # "task$iv":Lokhttp3/internal/concurrent/Task;
    const/4 v4, 0x0

    .line 224
    .restart local v4    # "$i$f$taskLog":I
    :try_start_1
    sget-object v5, Lokhttp3/internal/concurrent/TaskRunner;->Companion:Lokhttp3/internal/concurrent/TaskRunner$Companion;
    ...
    .line 68
    .local v5, "$i$a$-taskLog-TaskQueue$schedule$1$2":I
    const-string v6, "schedule failed (queue is shutdown)"

    .end local v5    # "$i$a$-taskLog-TaskQueue$schedule$1$2":I
    invoke-static {v3, v2, v6}, Lokhttp3/internal/concurrent/TaskLoggerKt;->access$log(Lokhttp3/internal/concurrent/Task;Lokhttp3/internal/concurrent/TaskQueue;Ljava/lang/String;)V
...
.method public final scheduleAndDecide$okhttp(Lokhttp3/internal/concurrent/Task;JZ)Z
    ...
    .local v8, "queue$iv":Lokhttp3/internal/concurrent/TaskQueue;
    const/4 v9, 0x0
    ...
    .line 153
    .local v10, "$i$a$-taskLog-TaskQueue$scheduleAndDecide$1":I
    nop

    .end local v10    # "$i$a$-taskLog-TaskQueue$scheduleAndDecide$1":I
    ...
    .line 154
    .end local v8    # "queue$iv":Lokhttp3/internal/concurrent/TaskQueue;
    ...
    .line 160
    .local v11, "$i$a$-taskLog-TaskQueue$scheduleAndDecide$2":I
    if-eqz p4, :cond_3
    ...
    .line 160
    .end local v11    # "$i$a$-taskLog-TaskQueue$scheduleAndDecide$2":I
    :goto_0
