...
.method private final findConnection(IIIIZ)Lokhttp3/internal/connection/RealConnection;
    ...
    .line 156
    .local v5, "toClose":Ljava/lang/Object;
    monitor-enter v2

    const/4 v6, 0x0

    .line 157
    .local v6, "$i$a$-synchronized-ExchangeFinder$findConnection$1":I
    :try_start_0
    ...
    .line 160
    .end local v6    # "$i$a$-synchronized-ExchangeFinder$findConnection$1":I
    :cond_1
    ...
    .line 175
    .end local v5    # "toClose":Ljava/lang/Object;
    :cond_6
    :goto_1
    ...
    .line 188
    .local v5, "routes":Ljava/util/List;
    const/4 v6, 0x0
    ...
    .line 192
    .end local v5    # "routes":Ljava/util/List;
    ...
    .line 201
    .local v7, "localRouteSelector":Lokhttp3/internal/connection/RouteSelector;
    if-nez v7, :cond_a
    ...
    .line 220
    .end local v6    # "route":Lokhttp3/Route;
    .end local v7    # "localRouteSelector":Lokhttp3/internal/connection/RouteSelector;
    ...
    .line 224
    .local v6, "newConnection":Lokhttp3/internal/connection/RealConnection;
    iget-object v7, v1, Lokhttp3/internal/connection/ExchangeFinder;->call:Lokhttp3/internal/connection/RealCall;
    ...
    .local v5, "routes":Ljava/util/List;
    .local v6, "route":Lokhttp3/Route;
    .restart local v7    # "localRouteSelector":Lokhttp3/internal/connection/RouteSelector;
...
.method private final retryRoute()Lokhttp3/Route;
    ...
    .line 313
    .local v1, "$i$a$-synchronized-ExchangeFinder$retryRoute$1":I
    :try_start_0
    ...
    .end local v1    # "$i$a$-synchronized-ExchangeFinder$retryRoute$1":I
    monitor-exit v0

    return-object v2

    .line 314
    .restart local v1    # "$i$a$-synchronized-ExchangeFinder$retryRoute$1":I
    :cond_1
    :try_start_1
...
.method public final retryAfterFailure()Z
    ...
    .line 294
    .end local v1    # "localRouteSelector":Lokhttp3/internal/connection/RouteSelector;
    :cond_4
    return v1
.end method
