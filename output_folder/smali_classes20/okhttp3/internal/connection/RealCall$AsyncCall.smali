...
.method public run()V
    ...
    .line 514
    .local v4, "$i$a$-threadName-RealCall$AsyncCall$run$1":I
    const/4 v5, 0x0

    .line 515
    .local v5, "signalledCallback":Z
    :try_start_0
    ...
    .line 531
    .local v7, "canceledException":Ljava/io/IOException;
    move-object v8, v7
    ...
    .line 534
    .end local v7    # "canceledException":Ljava/io/IOException;
    :cond_0
    nop

    .end local v0    # "name$iv":Ljava/lang/String;
    .end local v1    # "$i$f$threadName":I
    .end local v2    # "currentThread$iv":Ljava/lang/Thread;
    .end local v3    # "oldName$iv":Ljava/lang/String;
    .end local v4    # "$i$a$-threadName-RealCall$AsyncCall$run$1":I
    .end local v5    # "signalledCallback":Z
    throw v6

    .end local v6    # "t":Ljava/lang/Throwable;
    .restart local v0    # "name$iv":Ljava/lang/String;
    .restart local v1    # "$i$f$threadName":I
    .restart local v2    # "currentThread$iv":Ljava/lang/Thread;
    .restart local v3    # "oldName$iv":Ljava/lang/String;
    .restart local v4    # "$i$a$-threadName-RealCall$AsyncCall$run$1":I
    .restart local v5    # "signalledCallback":Z
    :catchall_1
    move-exception v6
    ...
    invoke-virtual {v7, v8, v9, v10}, Lokhttp3/internal/platform/Platform;->log(Ljava/lang/String;ILjava/lang/Throwable;)V
