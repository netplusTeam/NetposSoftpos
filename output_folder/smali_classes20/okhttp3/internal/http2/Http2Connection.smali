...
.method static constructor <clinit>()V
    ...
    .local v1, "$this$apply":Lokhttp3/internal/http2/Settings;
    const/4 v2, 0x0
    ...
    .line 995
    .end local v1    # "$this$apply":Lokhttp3/internal/http2/Settings;
...
.method public constructor <init>(Lokhttp3/internal/http2/Http2Connection$Builder;)V
    ...
    .local v3, "$this$apply":Lokhttp3/internal/http2/Settings;
    const/4 v4, 0x0
    ...
    .line 116
    .end local v3    # "$this$apply":Lokhttp3/internal/http2/Settings;
    ...
    .line 1127
    .local v1, "$i$f$schedule":I
    new-instance v10, Lokhttp3/internal/http2/Http2Connection$$special$$inlined$schedule$1;
    ...
    invoke-direct/range {v4 .. v9}, Lokhttp3/internal/http2/Http2Connection$$special$$inlined$schedule$1;-><init>(Ljava/lang/String;Ljava/lang/String;Lokhttp3/internal/http2/Http2Connection;J)V
    ...
    .line 1127
    invoke-virtual {v0, v10, v2, v3}, Lokhttp3/internal/concurrent/TaskQueue;->schedule(Lokhttp3/internal/concurrent/Task;J)V

    .line 170
    .end local v0    # "this_$iv":Lokhttp3/internal/concurrent/TaskQueue;
    .end local v1    # "$i$f$schedule":I
...
.method private final newStream(ILjava/util/List;Z)Lokhttp3/internal/http2/Http2Stream;
    ...
    :try_start_2
    iput v2, v7, Lokhttp3/internal/http2/Http2Connection;->nextStreamId:I
    ...
    .end local v13    # "stream":Lokhttp3/internal/http2/Http2Stream;
    ...
    .restart local v13    # "stream":Lokhttp3/internal/http2/Http2Stream;
...
.method public final pushDataLater$okhttp(ILokio/BufferedSource;IZ)V
    ...
    invoke-interface {v11, v13, v0, v1}, Lokio/BufferedSource;->read(Lokio/Buffer;J)J

    .line 938
    iget-object v14, v10, Lokhttp3/internal/http2/Http2Connection;->pushQueue:Lokhttp3/internal/concurrent/TaskQueue;
    ...
    new-instance v18, Lokhttp3/internal/http2/Http2Connection$pushDataLater$$inlined$execute$1;
    ...
    invoke-direct/range {v0 .. v9}, Lokhttp3/internal/http2/Http2Connection$pushDataLater$$inlined$execute$1;-><init>(Ljava/lang/String;ZLjava/lang/String;ZLokhttp3/internal/http2/Http2Connection;ILokio/Buffer;IZ)V
    ...
    .line 1109
    invoke-virtual {v14, v0, v10, v11}, Lokhttp3/internal/concurrent/TaskQueue;->schedule(Lokhttp3/internal/concurrent/Task;J)V
...
.method public final pushHeadersLater$okhttp(ILjava/util/List;Z)V
    ...
    .local v11, "this_$iv":Lokhttp3/internal/concurrent/TaskQueue;
    new-instance v0, Ljava/lang/StringBuilder;
    ...
    new-instance v17, Lokhttp3/internal/http2/Http2Connection$pushHeadersLater$$inlined$execute$1;
    ...
    .line 1098
    invoke-virtual {v11, v0, v13, v14}, Lokhttp3/internal/concurrent/TaskQueue;->schedule(Lokhttp3/internal/concurrent/Task;J)V
    ...
    .line 922
    .end local v1    # "name$iv":Ljava/lang/String;
    .end local v11    # "this_$iv":Lokhttp3/internal/concurrent/TaskQueue;
...
.method public final pushRequestLater$okhttp(ILjava/util/List;)V
    ...
    :try_start_0
    iget-object v1, v9, Lokhttp3/internal/http2/Http2Connection;->currentPushRequests:Ljava/util/Set;
    ...
    invoke-virtual {v9, v10, v1}, Lokhttp3/internal/http2/Http2Connection;->writeSynResetLater$okhttp(ILokhttp3/internal/http2/ErrorCode;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 893
    iget-object v0, v9, Lokhttp3/internal/http2/Http2Connection;->pushQueue:Lokhttp3/internal/concurrent/TaskQueue;
    ...
    iget-object v2, v9, Lokhttp3/internal/http2/Http2Connection;->connectionName:Ljava/lang/String;
    ...
    .line 1087
    .local v16, "$i$f$execute":I
    new-instance v17, Lokhttp3/internal/http2/Http2Connection$pushRequestLater$$inlined$execute$1;
    ...
    invoke-direct/range {v1 .. v8}, Lokhttp3/internal/http2/Http2Connection$pushRequestLater$$inlined$execute$1;-><init>(Ljava/lang/String;ZLjava/lang/String;ZLokhttp3/internal/http2/Http2Connection;ILjava/util/List;)V
    ...
    .line 1087
    invoke-virtual {v0, v1, v13, v14}, Lokhttp3/internal/concurrent/TaskQueue;->schedule(Lokhttp3/internal/concurrent/Task;J)V
...
.method public final pushResetLater$okhttp(ILokhttp3/internal/http2/ErrorCode;)V
    ...
    .line 952
    iget-object v10, v8, Lokhttp3/internal/http2/Http2Connection;->pushQueue:Lokhttp3/internal/concurrent/TaskQueue;
    ...
    .line 1120
    .local v16, "$i$f$execute":I
    new-instance v17, Lokhttp3/internal/http2/Http2Connection$pushResetLater$$inlined$execute$1;
    ...
    invoke-direct/range {v0 .. v7}, Lokhttp3/internal/http2/Http2Connection$pushResetLater$$inlined$execute$1;-><init>(Ljava/lang/String;ZLjava/lang/String;ZLokhttp3/internal/http2/Http2Connection;ILokhttp3/internal/http2/ErrorCode;)V
    ...
    .line 1120
    invoke-virtual {v10, v0, v13, v14}, Lokhttp3/internal/concurrent/TaskQueue;->schedule(Lokhttp3/internal/concurrent/Task;J)V
...
.method public final sendDegradedPingLater$okhttp()V
    ...
    new-instance v12, Lokhttp3/internal/http2/Http2Connection$sendDegradedPingLater$$inlined$execute$1;
...
.method public final shutdown(Lokhttp3/internal/http2/ErrorCode;)V
    ...
    .restart local v2    # "lastGoodStreamId":I
...
.method public final start(ZLokhttp3/internal/concurrent/TaskRunner;)V
    ...
    .local v0, "this_$iv":Lokhttp3/internal/concurrent/TaskQueue;
    iget-object v7, p0, Lokhttp3/internal/http2/Http2Connection;->connectionName:Ljava/lang/String;
...
.method public final writeSynResetLater$okhttp(ILokhttp3/internal/http2/ErrorCode;)V
    ...
    .line 340
    iget-object v10, v8, Lokhttp3/internal/http2/Http2Connection;->writerQueue:Lokhttp3/internal/concurrent/TaskQueue;
    ...
    .line 1014
    .local v16, "$i$f$execute":I
    new-instance v17, Lokhttp3/internal/http2/Http2Connection$writeSynResetLater$$inlined$execute$1;
    ...
    invoke-direct/range {v0 .. v7}, Lokhttp3/internal/http2/Http2Connection$writeSynResetLater$$inlined$execute$1;-><init>(Ljava/lang/String;ZLjava/lang/String;ZLokhttp3/internal/http2/Http2Connection;ILokhttp3/internal/http2/ErrorCode;)V
...
.method public final writeWindowUpdateLater$okhttp(IJ)V
    ...
    iget-object v10, v9, Lokhttp3/internal/http2/Http2Connection;->writerQueue:Lokhttp3/internal/concurrent/TaskQueue;
    ...
    new-instance v16, Lokhttp3/internal/http2/Http2Connection$writeWindowUpdateLater$$inlined$execute$1;
    ...
    invoke-direct/range {v0 .. v8}, Lokhttp3/internal/http2/Http2Connection$writeWindowUpdateLater$$inlined$execute$1;-><init>(Ljava/lang/String;ZLjava/lang/String;ZLokhttp3/internal/http2/Http2Connection;IJ)V
