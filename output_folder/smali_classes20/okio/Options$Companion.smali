...
.method private final buildTrieRecursive(JLokio/Buffer;ILjava/util/List;IILjava/util/List;)V
    ...
    .local v21, "rangeStart":I
    move-object v5, v6

    move-object/from16 v22, v6

    .end local v6    # "childNodes":Lokio/Buffer;
    .local v22, "childNodes":Lokio/Buffer;
    move/from16 v6, v18

    move/from16 v18, v7

    .end local v7    # "selectChoiceCount":I
    ...
    .local v23, "from":Lokio/ByteString;
    move/from16 v9, v20

    move v13, v10

    .end local v10    # "fromIndex":I
    .local v13, "fromIndex":I
    ...
    .line 187
    .end local v13    # "fromIndex":I
    .end local v14    # "prefixIndex":I
    .end local v18    # "selectChoiceCount":I
    .end local v22    # "childNodes":Lokio/Buffer;
    .end local v23    # "from":Lokio/ByteString;
    .restart local v6    # "childNodes":Lokio/Buffer;
    .restart local v7    # "selectChoiceCount":I
    ...
    .end local v9    # "from":Lokio/ByteString;
    .end local v10    # "fromIndex":I
    .restart local v13    # "fromIndex":I
    .restart local v14    # "prefixIndex":I
    .restart local v18    # "selectChoiceCount":I
    .restart local v21    # "rangeStart":I
    .restart local v22    # "childNodes":Lokio/Buffer;
    .restart local v23    # "from":Lokio/ByteString;
    ...
    .local v18, "childNodes":Lokio/Buffer;
    move-object/from16 v7, p5

    move/from16 v19, v8

    .end local v8    # "fromIndex":I
    .local v19, "fromIndex":I
    move-object/from16 v20, v9

    .end local v9    # "from":Lokio/ByteString;
    .local v20, "from":Lokio/ByteString;
    move/from16 v9, p7

    move/from16 v21, v10

    .end local v10    # "scanByteCount":I
    .local v21, "scanByteCount":I
    move-object/from16 v10, p8
    ...
    .line 226
    .end local v16    # "childNodesOffset":J
    .end local v18    # "childNodes":Lokio/Buffer;
    .end local v21    # "scanByteCount":I
    :goto_d
    nop
    ...
    .line 116
    .end local v14    # "prefixIndex":I
    .end local v15    # "to":Lokio/ByteString;
    .end local v19    # "fromIndex":I
    .end local v20    # "from":Lokio/ByteString;
    :cond_16
    new-instance v2, Ljava/lang/IllegalArgumentException;
