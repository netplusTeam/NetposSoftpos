...
.method public static final commonExhausted(Lokio/RealBufferedSource;)Z
    ...
    .line 48
    .local v1, "$i$a$-check-RealBufferedSourceKt$commonExhausted$1":I
    nop

    .end local v1    # "$i$a$-check-RealBufferedSourceKt$commonExhausted$1":I
...
.method public static final commonIndexOf(Lokio/RealBufferedSource;BJJ)J
    ...
    .line 313
    .local v3, "$i$a$-require-RealBufferedSourceKt$commonIndexOf$2":I
    ...
    .end local v3    # "$i$a$-require-RealBufferedSourceKt$commonIndexOf$2":I
    ...
    .line 312
    .local v3, "$i$a$-check-RealBufferedSourceKt$commonIndexOf$1":I
    nop

    .end local v3    # "$i$a$-check-RealBufferedSourceKt$commonIndexOf$1":I
...
.method public static final commonIndexOf(Lokio/RealBufferedSource;Lokio/ByteString;J)J
    ...
    .line 332
    .local v5, "$i$a$-check-RealBufferedSourceKt$commonIndexOf$3":I
    nop

    .end local v5    # "$i$a$-check-RealBufferedSourceKt$commonIndexOf$3":I
...
.method public static final commonIndexOfElement(Lokio/RealBufferedSource;Lokio/ByteString;J)J
    ...
    const-string v3, "$this$commonIndexOfElement"
    ...
    .line 348
    .local v5, "$i$a$-check-RealBufferedSourceKt$commonIndexOfElement$1":I
    nop

    .end local v5    # "$i$a$-check-RealBufferedSourceKt$commonIndexOfElement$1":I
    new-instance v5, Ljava/lang/IllegalStateException;
...
.method public static final commonRangeEquals(Lokio/RealBufferedSource;JLokio/ByteString;II)Z
    ...
    .line 368
    .local v1, "$i$a$-check-RealBufferedSourceKt$commonRangeEquals$1":I
    nop

    .end local v1    # "$i$a$-check-RealBufferedSourceKt$commonRangeEquals$1":I
    new-instance v1, Ljava/lang/IllegalStateException;
...
.method public static final commonRead(Lokio/RealBufferedSource;Lokio/Buffer;J)J
    ...
    .line 36
    .local v1, "$i$a$-check-RealBufferedSourceKt$commonRead$2":I
    nop

    .end local v1    # "$i$a$-check-RealBufferedSourceKt$commonRead$2":I
    new-instance v1, Ljava/lang/IllegalStateException;
    ...
    .line 35
    .local v1, "$i$a$-require-RealBufferedSourceKt$commonRead$1":I
    ...
    .end local v1    # "$i$a$-require-RealBufferedSourceKt$commonRead$1":I
...
.method public static final commonReadUtf8LineStrict(Lokio/RealBufferedSource;J)Ljava/lang/String;
    ...
    .end local v2    # "this_$iv":Lokio/RealBufferedSource;
    .end local v3    # "$i$f$getBuffer":I
    invoke-static {v2, v14, v15}, Lokio/internal/BufferKt;->readUtf8Line(Lokio/Buffer;J)Ljava/lang/String;
    ...
    .line 195
    .local v0, "$i$a$-require-RealBufferedSourceKt$commonReadUtf8LineStrict$1":I
    ...
    .end local v0    # "$i$a$-require-RealBufferedSourceKt$commonReadUtf8LineStrict$1":I
...
.method public static final commonRequest(Lokio/RealBufferedSource;J)Z
    ...
    .line 58
    .local v1, "$i$a$-check-RealBufferedSourceKt$commonRequest$2":I
    nop

    .end local v1    # "$i$a$-check-RealBufferedSourceKt$commonRequest$2":I
    new-instance v1, Ljava/lang/IllegalStateException;
    ...
    .line 57
    .local v1, "$i$a$-require-RealBufferedSourceKt$commonRequest$1":I
    new-instance v2, Ljava/lang/StringBuilder;
    ...
    .end local v1    # "$i$a$-require-RealBufferedSourceKt$commonRequest$1":I
    new-instance v2, Ljava/lang/IllegalArgumentException;
...
.method public static final commonSelect(Lokio/RealBufferedSource;Lokio/Options;)I
    ...
    .line 81
    .local v1, "$i$a$-check-RealBufferedSourceKt$commonSelect$1":I
    nop

    .end local v1    # "$i$a$-check-RealBufferedSourceKt$commonSelect$1":I
    new-instance v1, Ljava/lang/IllegalStateException;
...
.method public static final commonSkip(Lokio/RealBufferedSource;J)V
    ...
    .line 299
    .local v3, "$i$a$-check-RealBufferedSourceKt$commonSkip$1":I
    nop

    .end local v3    # "$i$a$-check-RealBufferedSourceKt$commonSkip$1":I
    new-instance v3, Ljava/lang/IllegalStateException;
