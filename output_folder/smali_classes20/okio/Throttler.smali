...
.method public final bytesPerSecond(JJJ)V
    ...
    .line 59
    .local v2, "$i$a$-synchronized-Throttler$bytesPerSecond$1":I
    const-wide/16 v3, 0x0
    ...
    .line 67
    .end local v2    # "$i$a$-synchronized-Throttler$bytesPerSecond$1":I
    ...
    .restart local v2    # "$i$a$-synchronized-Throttler$bytesPerSecond$1":I
    :cond_3
    :try_start_1
...
.method public final take$okio(J)J
    ...
    .line 78
    .local v4, "$i$a$-synchronized-Throttler$take$1":I
    :goto_1
    nop
    ...
    .line 81
    .local v7, "byteCountOrWaitNanos":J
    cmp-long v9, v7, v0
    ...
    .end local v4    # "$i$a$-synchronized-Throttler$take$1":I
    .end local v5    # "now":J
    .end local v7    # "byteCountOrWaitNanos":J
    monitor-exit v2
    ...
    .restart local v4    # "$i$a$-synchronized-Throttler$take$1":I
    .restart local v5    # "now":J
    .restart local v7    # "byteCountOrWaitNanos":J
    :cond_1
    neg-long v9, v7
