...
.method protected flatten(Lorg/apache/commons/cli/Options;[Ljava/lang/String;Z)[Ljava/lang/String;
    ...
    :goto_1
    invoke-virtual {p1, v7}, Lorg/apache/commons/cli/Options;->getMatchingOptions(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {p1, v5}, Lorg/apache/commons/cli/Options;->getOption(Ljava/lang/String;)Lorg/apache/commons/cli/Option;
    ...
    iget-object v6, p0, Lorg/apache/commons/cli/PosixParser;->currentOption:Lorg/apache/commons/cli/Option;

    invoke-virtual {v6}, Lorg/apache/commons/cli/Option;->getLongOpt()Ljava/lang/String;
    ...
    :cond_4
    new-instance v3, Lorg/apache/commons/cli/AmbiguousOptionException;

    invoke-direct {v3, v7, v8}, Lorg/apache/commons/cli/AmbiguousOptionException;-><init>(Ljava/lang/String;Ljava/util/Collection;)V
    ...
    .line 150
    :cond_6
    invoke-virtual {p1, v1}, Lorg/apache/commons/cli/Options;->getMatchingOptions(Ljava/lang/String;)Ljava/util/List;
    ...
    .line 158
    .local v4, "opt":Lorg/apache/commons/cli/Option;
    ...
    invoke-virtual {v4}, Lorg/apache/commons/cli/Option;->getLongOpt()Ljava/lang/String;
    ...
    invoke-direct {p0, v2, p3}, Lorg/apache/commons/cli/PosixParser;->processOptionToken(Ljava/lang/String;Z)V

    .line 159
    .end local v3    # "matchingOpts":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .end local v4    # "opt":Lorg/apache/commons/cli/Option;
    goto :goto_5
    ...
    invoke-direct {v2, v1, v3}, Lorg/apache/commons/cli/AmbiguousOptionException;-><init>(Ljava/lang/String;Ljava/util/Collection;)V
