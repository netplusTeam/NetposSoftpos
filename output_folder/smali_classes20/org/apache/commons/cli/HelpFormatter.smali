...
.method private appendOption(Ljava/lang/StringBuffer;Lorg/apache/commons/cli/Option;Z)V
    .locals 2
    ...
    .line 688
    :cond_0
    invoke-virtual {p2}, Lorg/apache/commons/cli/Option;->getOpt()Ljava/lang/String;
    ...
    invoke-virtual {p2}, Lorg/apache/commons/cli/Option;->getLongOpt()Ljava/lang/String;
    ...
    invoke-virtual {p2}, Lorg/apache/commons/cli/Option;->getArgName()Ljava/lang/String;
    ...
    iget-object v0, p0, Lorg/apache/commons/cli/HelpFormatter;->longOptSeparator:Ljava/lang/String;
...
.method private appendOptionGroup(Ljava/lang/StringBuffer;Lorg/apache/commons/cli/OptionGroup;)V
    ...
    .line 652
    .local v0, "optList":Ljava/util/List;, "Ljava/util/List<Lorg/apache/commons/cli/Option;>;"
    ...
    .local v1, "it":Ljava/util/Iterator;, "Ljava/util/Iterator<Lorg/apache/commons/cli/Option;>;"
    :cond_2
    :goto_0
    ...
    invoke-direct {p0, p1, v2, v3}, Lorg/apache/commons/cli/HelpFormatter;->appendOption(Ljava/lang/StringBuffer;Lorg/apache/commons/cli/Option;Z)V
    ...
    .line 668
    .end local v1    # "it":Ljava/util/Iterator;, "Ljava/util/Iterator<Lorg/apache/commons/cli/Option;>;"
    :cond_3
    invoke-virtual {p2}, Lorg/apache/commons/cli/OptionGroup;->isRequired()Z
...
.method private renderWrappedTextBlock(Ljava/lang/StringBuffer;IILjava/lang/String;)Ljava/lang/Appendable;
    ...
    .line 959
    :goto_1
    invoke-virtual {p0, p1, p2, p3, v3}, Lorg/apache/commons/cli/HelpFormatter;->renderWrappedText(Ljava/lang/StringBuffer;IILjava/lang/String;)Ljava/lang/StringBuffer;
    :try_end_0
...
.method public printHelp(ILjava/lang/String;Ljava/lang/String;Lorg/apache/commons/cli/Options;Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0}, Lorg/apache/commons/cli/HelpFormatter;->getLeftPadding()I

    move-result v6

    invoke-virtual {p0}, Lorg/apache/commons/cli/HelpFormatter;->getDescPadding()I
...
.method public printHelp(Ljava/lang/String;Ljava/lang/String;Lorg/apache/commons/cli/Options;Ljava/lang/String;Z)V
    ...
    .line 455
    invoke-virtual {p0}, Lorg/apache/commons/cli/HelpFormatter;->getWidth()I
...
.method public printUsage(Ljava/io/PrintWriter;ILjava/lang/String;)V
    ...
    .line 723
    .local v0, "argPos":I
    invoke-virtual {p0}, Lorg/apache/commons/cli/HelpFormatter;->getSyntaxPrefix()Ljava/lang/String;
...
.method public printUsage(Ljava/io/PrintWriter;ILjava/lang/String;Lorg/apache/commons/cli/Options;)V
    ...
    .line 587
    .local v2, "processedGroups":Ljava/util/Collection;, "Ljava/util/Collection<Lorg/apache/commons/cli/OptionGroup;>;"
    ...
    .line 588
    .local v3, "optList":Ljava/util/List;, "Ljava/util/List<Lorg/apache/commons/cli/Option;>;"
    invoke-virtual {p0}, Lorg/apache/commons/cli/HelpFormatter;->getOptionComparator()Ljava/util/Comparator;
    ...
    .local v4, "it":Ljava/util/Iterator;, "Ljava/util/Iterator<Lorg/apache/commons/cli/Option;>;"
    :goto_0
    ...
    .line 599
    .local v5, "option":Lorg/apache/commons/cli/Option;
    invoke-virtual {p4, v5}, Lorg/apache/commons/cli/Options;->getOptionGroup(Lorg/apache/commons/cli/Option;)Lorg/apache/commons/cli/OptionGroup;

    move-result-object v6

    .line 602
    .local v6, "group":Lorg/apache/commons/cli/OptionGroup;
    if-eqz v6, :cond_1
    ...
    .line 612
    invoke-direct {p0, v0, v6}, Lorg/apache/commons/cli/HelpFormatter;->appendOptionGroup(Ljava/lang/StringBuffer;Lorg/apache/commons/cli/OptionGroup;)V

    goto :goto_1

    .line 622
    :cond_1
    invoke-virtual {v5}, Lorg/apache/commons/cli/Option;->isRequired()Z

    move-result v7

    invoke-direct {p0, v0, v5, v7}, Lorg/apache/commons/cli/HelpFormatter;->appendOption(Ljava/lang/StringBuffer;Lorg/apache/commons/cli/Option;Z)V
    ...
    .line 629
    .end local v5    # "option":Lorg/apache/commons/cli/Option;
    .end local v6    # "group":Lorg/apache/commons/cli/OptionGroup;
    :cond_3
    goto :goto_0

    .line 633
    .end local v4    # "it":Ljava/util/Iterator;, "Ljava/util/Iterator<Lorg/apache/commons/cli/Option;>;"
    :cond_4
    ...
    invoke-virtual {p0, p1, p2, v1, v4}, Lorg/apache/commons/cli/HelpFormatter;->printWrapped(Ljava/io/PrintWriter;IILjava/lang/String;)V
...
.method public printWrapped(Ljava/io/PrintWriter;IILjava/lang/String;)V
    ...
    invoke-direct {p0, v0, p2, p3, p4}, Lorg/apache/commons/cli/HelpFormatter;->renderWrappedTextBlock(Ljava/lang/StringBuffer;IILjava/lang/String;)Ljava/lang/Appendable;
...
.method protected renderOptions(Ljava/lang/StringBuffer;ILorg/apache/commons/cli/Options;II)Ljava/lang/StringBuffer;
    ...
    invoke-virtual {v0, v2}, Lorg/apache/commons/cli/HelpFormatter;->createPadding(I)Ljava/lang/String;
    ...
    .line 805
    .local v8, "optList":Ljava/util/List;, "Ljava/util/List<Lorg/apache/commons/cli/Option;>;"
    ...
    invoke-virtual/range {p0 .. p0}, Lorg/apache/commons/cli/HelpFormatter;->getLongOptPrefix()Ljava/lang/String;
    ...
    invoke-virtual/range {p0 .. p0}, Lorg/apache/commons/cli/HelpFormatter;->getOptPrefix()Ljava/lang/String;
    ...
    iget-object v13, v0, Lorg/apache/commons/cli/HelpFormatter;->longOptSeparator:Ljava/lang/String;
    ...
    :cond_5
    invoke-virtual/range {p0 .. p0}, Lorg/apache/commons/cli/HelpFormatter;->getArgName()Ljava/lang/String;
    ...
    .local v10, "it":Ljava/util/Iterator;, "Ljava/util/Iterator<Lorg/apache/commons/cli/Option;>;"
    :goto_6
    ...
    .line 852
    .local v11, "option":Lorg/apache/commons/cli/Option;
    ...
    invoke-virtual {v0, v12}, Lorg/apache/commons/cli/HelpFormatter;->createPadding(I)Ljava/lang/String;
    ...
    invoke-virtual {v11}, Lorg/apache/commons/cli/Option;->getDescription()Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, v15, v12, v14}, Lorg/apache/commons/cli/HelpFormatter;->renderWrappedText(Ljava/lang/StringBuffer;IILjava/lang/String;)Ljava/lang/StringBuffer;
    ...
    .line 872
    invoke-virtual/range {p0 .. p0}, Lorg/apache/commons/cli/HelpFormatter;->getNewLine()Ljava/lang/String;
    ...
    .end local v11    # "option":Lorg/apache/commons/cli/Option;
    ...
    .line 876
    .end local v10    # "it":Ljava/util/Iterator;, "Ljava/util/Iterator<Lorg/apache/commons/cli/Option;>;"
    return-object v1
.end method
...
.method protected renderWrappedText(Ljava/lang/StringBuffer;IILjava/lang/String;)Ljava/lang/StringBuffer;
    ...
    invoke-virtual {p0, v4}, Lorg/apache/commons/cli/HelpFormatter;->rtrim(Ljava/lang/String;)Ljava/lang/String;
...
.method public setLongOptSeparator(Ljava/lang/String;)V
    ...
    .line 340
    iput-object p1, p0, Lorg/apache/commons/cli/HelpFormatter;->longOptSeparator:Ljava/lang/String;
...
.method public setOptionComparator(Ljava/util/Comparator;)V
    ...
    .line 395
    .local p1, "comparator":Ljava/util/Comparator;, "Ljava/util/Comparator<Lorg/apache/commons/cli/Option;>;"
