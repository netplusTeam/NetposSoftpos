...
.method public static parsePattern(Ljava/lang/String;)Lorg/apache/commons/cli/Options;
    ...
    invoke-static {v7}, Lorg/apache/commons/cli/Option;->builder(Ljava/lang/String;)Lorg/apache/commons/cli/Option$Builder;
    ...
    .line 169
    :cond_0
    invoke-virtual {v7, v6}, Lorg/apache/commons/cli/Option$Builder;->hasArg(Z)Lorg/apache/commons/cli/Option$Builder;

    move-result-object v6

    .line 170
    invoke-virtual {v6, v1}, Lorg/apache/commons/cli/Option$Builder;->required(Z)Lorg/apache/commons/cli/Option$Builder;

    move-result-object v6

    .line 171
    invoke-virtual {v6, v2}, Lorg/apache/commons/cli/Option$Builder;->type(Ljava/lang/Class;)Lorg/apache/commons/cli/Option$Builder;

    move-result-object v6

    .line 172
    invoke-virtual {v6}, Lorg/apache/commons/cli/Option$Builder;->build()Lorg/apache/commons/cli/Option;

    move-result-object v6

    .line 175
    .local v6, "option":Lorg/apache/commons/cli/Option;
    ...
    .line 181
    .end local v6    # "option":Lorg/apache/commons/cli/Option;
    :cond_1
    move v0, v5
    ...
    invoke-static {v4}, Lorg/apache/commons/cli/Option;->builder(Ljava/lang/String;)Lorg/apache/commons/cli/Option$Builder;
    ...
    .line 196
    :cond_5
    invoke-virtual {v4, v6}, Lorg/apache/commons/cli/Option$Builder;->hasArg(Z)Lorg/apache/commons/cli/Option$Builder;

    move-result-object v4

    .line 197
    invoke-virtual {v4, v1}, Lorg/apache/commons/cli/Option$Builder;->required(Z)Lorg/apache/commons/cli/Option$Builder;

    move-result-object v4

    .line 198
    invoke-virtual {v4, v2}, Lorg/apache/commons/cli/Option$Builder;->type(Ljava/lang/Class;)Lorg/apache/commons/cli/Option$Builder;

    move-result-object v4

    .line 199
    invoke-virtual {v4}, Lorg/apache/commons/cli/Option$Builder;->build()Lorg/apache/commons/cli/Option;
