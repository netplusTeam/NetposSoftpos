...
.method private static body([III)[I
    ...
    invoke-static/range {v4 .. v9}, Lorg/apache/commons/codec/digest/UnixCrypt;->dEncrypt(IIIII[I)I
...
.method public static crypt([BLjava/lang/String;)Ljava/lang/String;
    ...
    .line 205
    .local v2, "randomGenerator":Ljava/util/concurrent/ThreadLocalRandom;
    sget-object v3, Lorg/apache/commons/codec/digest/UnixCrypt;->SALT_CHARS:[C

    array-length v4, v3

    .line 206
    .local v4, "numSaltChars":I
    ...
    .line 208
    .end local v2    # "randomGenerator":Ljava/util/concurrent/ThreadLocalRandom;
    .end local v4    # "numSaltChars":I
...
.method private static desSetKey([B)[I
    ...
    invoke-static {v3, v9, v10}, Lorg/apache/commons/codec/digest/UnixCrypt;->hPermOp(III)I

    move-result v3

    .line 355
    invoke-static {v5, v9, v10}, Lorg/apache/commons/codec/digest/UnixCrypt;->hPermOp(III)I
