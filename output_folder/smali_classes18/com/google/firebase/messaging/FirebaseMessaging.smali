...
.method constructor <init>(Lcom/google/firebase/FirebaseApp;Lcom/google/firebase/iid/internal/FirebaseInstanceIdInternal;Lcom/google/firebase/inject/Provider;Lcom/google/firebase/inject/Provider;Lcom/google/firebase/installations/FirebaseInstallationsApi;Lcom/google/android/datatransport/TransportFactory;Lcom/google/firebase/events/Subscriber;)V
    ...
    .param p2, "iid"    # Lcom/google/firebase/iid/internal/FirebaseInstanceIdInternal;
    .param p5, "firebaseInstallationsApi"    # Lcom/google/firebase/installations/FirebaseInstallationsApi;
    .param p6, "transportFactory"    # Lcom/google/android/datatransport/TransportFactory;
    .param p7, "subscriber"    # Lcom/google/firebase/events/Subscriber;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method constructor <init>(Lcom/google/firebase/FirebaseApp;Lcom/google/firebase/iid/internal/FirebaseInstanceIdInternal;Lcom/google/firebase/inject/Provider;Lcom/google/firebase/inject/Provider;Lcom/google/firebase/installations/FirebaseInstallationsApi;Lcom/google/android/datatransport/TransportFactory;Lcom/google/firebase/events/Subscriber;Lcom/google/firebase/messaging/Metadata;)V
    ...
    .param p6, "transportFactory"    # Lcom/google/android/datatransport/TransportFactory;
    .param p7, "subscriber"    # Lcom/google/firebase/events/Subscriber;
    .param p8, "metadata"    # Lcom/google/firebase/messaging/Metadata;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lcom/google/firebase/FirebaseApp;",
...
.method constructor <init>(Lcom/google/firebase/FirebaseApp;Lcom/google/firebase/iid/internal/FirebaseInstanceIdInternal;Lcom/google/firebase/installations/FirebaseInstallationsApi;Lcom/google/android/datatransport/TransportFactory;Lcom/google/firebase/events/Subscriber;Lcom/google/firebase/messaging/Metadata;Lcom/google/firebase/messaging/GmsRpc;Ljava/util/concurrent/Executor;Ljava/util/concurrent/Executor;Ljava/util/concurrent/Executor;)V
    ...
    .param p1, "firebaseApp"    # Lcom/google/firebase/FirebaseApp;
    .param p2, "iid"    # Lcom/google/firebase/iid/internal/FirebaseInstanceIdInternal;
    .param p3, "firebaseInstallationsApi"    # Lcom/google/firebase/installations/FirebaseInstallationsApi;
    .param p4, "transportFactory"    # Lcom/google/android/datatransport/TransportFactory;
    .param p5, "subscriber"    # Lcom/google/firebase/events/Subscriber;
    .param p6, "metadata"    # Lcom/google/firebase/messaging/Metadata;
    .param p7, "gmsRpc"    # Lcom/google/firebase/messaging/GmsRpc;
    .param p8, "taskExecutor"    # Ljava/util/concurrent/Executor;
    .param p9, "initExecutor"    # Ljava/util/concurrent/Executor;
    .param p10, "fileExecutor"    # Ljava/util/concurrent/Executor;
    ...
    .line 221
    new-instance v0, Lcom/google/firebase/messaging/FirebaseMessaging$AutoInit;

    invoke-direct {v0, p0, p5}, Lcom/google/firebase/messaging/FirebaseMessaging$AutoInit;-><init>(Lcom/google/firebase/messaging/FirebaseMessaging;Lcom/google/firebase/events/Subscriber;)V

    iput-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->autoInit:Lcom/google/firebase/messaging/FirebaseMessaging$AutoInit;
    ...
    iput-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->context:Landroid/content/Context;

    .line 223
    new-instance v1, Lcom/google/firebase/messaging/FcmLifecycleCallbacks;

    invoke-direct {v1}, Lcom/google/firebase/messaging/FcmLifecycleCallbacks;-><init>()V

    iput-object v1, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->lifecycleCallbacks:Landroid/app/Application$ActivityLifecycleCallbacks;
    ...
    .line 227
    new-instance v2, Lcom/google/firebase/messaging/RequestDeduplicator;

    invoke-direct {v2, p8}, Lcom/google/firebase/messaging/RequestDeduplicator;-><init>(Ljava/util/concurrent/Executor;)V

    iput-object v2, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->requestDeduplicator:Lcom/google/firebase/messaging/RequestDeduplicator;
    ...
    invoke-direct {v1, p0}, Lcom/google/firebase/messaging/FirebaseMessaging$$ExternalSyntheticLambda2;-><init>(Lcom/google/firebase/messaging/FirebaseMessaging;)V

    invoke-interface {p2, v1}, Lcom/google/firebase/iid/internal/FirebaseInstanceIdInternal;->addNewTokenListener(Lcom/google/firebase/iid/internal/FirebaseInstanceIdInternal$NewTokenListener;)V

    .line 251
    :cond_1
    new-instance v1, Lcom/google/firebase/messaging/FirebaseMessaging$$ExternalSyntheticLambda3;

    invoke-direct {v1, p0}, Lcom/google/firebase/messaging/FirebaseMessaging$$ExternalSyntheticLambda3;-><init>(Lcom/google/firebase/messaging/FirebaseMessaging;)V

    invoke-interface {p9, v1}, Ljava/util/concurrent/Executor;->execute(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v0, p9, v1}, Lcom/google/android/gms/tasks/Task;->addOnSuccessListener(Ljava/util/concurrent/Executor;Lcom/google/android/gms/tasks/OnSuccessListener;)Lcom/google/android/gms/tasks/Task;

    .line 274
    new-instance v0, Lcom/google/firebase/messaging/FirebaseMessaging$$ExternalSyntheticLambda5;

    invoke-direct {v0, p0}, Lcom/google/firebase/messaging/FirebaseMessaging$$ExternalSyntheticLambda5;-><init>(Lcom/google/firebase/messaging/FirebaseMessaging;)V

    invoke-interface {p9, v0}, Ljava/util/concurrent/Executor;->execute(Ljava/lang/Runnable;)V
...
.method static synthetic access$000(Lcom/google/firebase/messaging/FirebaseMessaging;)Lcom/google/firebase/FirebaseApp;
    .locals 1
    .param p0, "x0"    # Lcom/google/firebase/messaging/FirebaseMessaging;
...
.method static declared-synchronized getInstance(Lcom/google/firebase/FirebaseApp;)Lcom/google/firebase/messaging/FirebaseMessaging;
    ...
    .line 158
    .local v1, "firebaseMessaging":Lcom/google/firebase/messaging/FirebaseMessaging;
    ...
    .line 156
    .end local v1    # "firebaseMessaging":Lcom/google/firebase/messaging/FirebaseMessaging;
...
.method private invokeOnTokenRefresh(Ljava/lang/String;)V
    ...
    .line 651
    .local v0, "messagingIntent":Landroid/content/Intent;
    ...
    invoke-direct {v1, v2}, Lcom/google/firebase/messaging/FcmBroadcastProcessor;-><init>(Landroid/content/Context;)V

    invoke-virtual {v1, v0}, Lcom/google/firebase/messaging/FcmBroadcastProcessor;->process(Landroid/content/Intent;)Lcom/google/android/gms/tasks/Task;

    .line 656
    .end local v0    # "messagingIntent":Landroid/content/Intent;
    :cond_1
    return-void
.end method
...
.method private declared-synchronized startSync()V
    ...
    .line 579
    .end local p0    # "this":Lcom/google/firebase/messaging/FirebaseMessaging;
    :cond_0
    monitor-exit p0
...
.method private startSyncIfNecessary()V
    ...
    .line 570
    .local v0, "token":Lcom/google/firebase/messaging/Store$Token;
...
.method blockingGetToken()Ljava/lang/String;
    ...
    .line 600
    .local v0, "cachedToken":Lcom/google/firebase/messaging/Store$Token;
    invoke-virtual {p0, v0}, Lcom/google/firebase/messaging/FirebaseMessaging;->tokenNeedsRefresh(Lcom/google/firebase/messaging/Store$Token;)Z
    ...
    .line 601
    iget-object v1, v0, Lcom/google/firebase/messaging/Store$Token;->token:Ljava/lang/String;
    ...
    .line 623
    .local v2, "tokenTask":Lcom/google/android/gms/tasks/Task;, "Lcom/google/android/gms/tasks/Task<Ljava/lang/String;>;"
    :try_start_1
...
.method public deleteToken()Lcom/google/android/gms/tasks/Task;
    ...
    .line 424
    .end local v0    # "taskCompletionSource":Lcom/google/android/gms/tasks/TaskCompletionSource;, "Lcom/google/android/gms/tasks/TaskCompletionSource<Ljava/lang/Void;>;"
    :cond_0
    invoke-virtual {p0}, Lcom/google/firebase/messaging/FirebaseMessaging;->getTokenWithoutTriggeringSync()Lcom/google/firebase/messaging/Store$Token;
    ...
    .line 429
    .local v1, "taskCompletionSource":Lcom/google/android/gms/tasks/TaskCompletionSource;, "Lcom/google/android/gms/tasks/TaskCompletionSource<Ljava/lang/Void;>;"
    ...
    invoke-direct {v3, p0, v1}, Lcom/google/firebase/messaging/FirebaseMessaging$$ExternalSyntheticLambda9;-><init>(Lcom/google/firebase/messaging/FirebaseMessaging;Lcom/google/android/gms/tasks/TaskCompletionSource;)V
...
.method synthetic lambda$blockingGetToken$10$com-google-firebase-messaging-FirebaseMessaging(Ljava/lang/String;Lcom/google/firebase/messaging/Store$Token;)Lcom/google/android/gms/tasks/Task;
    ...
    .param p2, "cachedToken"    # Lcom/google/firebase/messaging/Store$Token;
...
.method synthetic lambda$blockingGetToken$9$com-google-firebase-messaging-FirebaseMessaging(Ljava/lang/String;Lcom/google/firebase/messaging/Store$Token;Ljava/lang/String;)Lcom/google/android/gms/tasks/Task;
    ...
    iget-object v0, p2, Lcom/google/firebase/messaging/Store$Token;->token:Ljava/lang/String;
...
.method public send(Lcom/google/firebase/messaging/RemoteMessage;)V
    ...
    .end local v1    # "dummyIntent":Landroid/content/Intent;
    :cond_1
...
.method declared-synchronized syncWithDelaySecondsInternal(J)V
    ...
    .line 546
    .local v2, "syncTask":Lcom/google/firebase/messaging/SyncTask;
    ...
    iput-boolean v3, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->syncScheduledOrRunning:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 543
    .end local v0    # "retryDelaySeconds":J
    .end local v2    # "syncTask":Lcom/google/firebase/messaging/SyncTask;
    .end local p0    # "this":Lcom/google/firebase/messaging/FirebaseMessaging;
    .end local p1    # "delaySeconds":J
    :catchall_0
    move-exception p1
...
.method tokenNeedsRefresh(Lcom/google/firebase/messaging/Store$Token;)Z
    .locals 1
    .param p1, "token"    # Lcom/google/firebase/messaging/Store$Token;
