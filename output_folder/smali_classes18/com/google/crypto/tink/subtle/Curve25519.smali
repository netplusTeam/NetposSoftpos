...
.method static curveMult([J[B[B)V
    ...
    .line 309
    .end local v24    # "nqpqz":[J
    .local v10, "nqpqz":[J
    move-object v9, v1

    .line 289
    .end local v13    # "nqpqz2":[J
    .end local v15    # "bit":I
    .restart local v9    # "nqpqz2":[J
    ...
    .end local v18    # "qBytesWithoutMsb":[B
    .end local v21    # "b":I
    .local v1, "qBytesWithoutMsb":[B
    ...
    .line 314
    .end local v1    # "qBytesWithoutMsb":[B
    .end local v12    # "i":I
    .restart local v18    # "qBytesWithoutMsb":[B
    const/16 v1, 0xa
...
.method private static validatePubKeyAndClearMsb([B)[B
    ...
    invoke-static {v3, v0}, Lcom/google/crypto/tink/subtle/Bytes;->equal([B[B)Z
    ...
    const-string v5, "Banned public key: "
    ...
    invoke-direct {v3, v2}, Ljava/security/InvalidKeyException;-><init>(Ljava/lang/String;)V
