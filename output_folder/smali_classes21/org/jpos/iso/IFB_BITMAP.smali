.class public Lorg/jpos/iso/IFB_BITMAP;
.super Lorg/jpos/iso/ISOBitMapPackager;
.source "IFB_BITMAP.java"
...
.method public getMaxPackedLength()I
    ...
    .line 87
    invoke-virtual {p0}, Lorg/jpos/iso/IFB_BITMAP;->getLength()I
...
.method public unpack(Lorg/jpos/iso/ISOComponent;[BI)I
    ...
    invoke-static {p2, p3, v0}, Lorg/jpos/iso/ISOUtil;->byte2BitSet([BII)Ljava/util/BitSet;
...
.method public unpack(Lorg/jpos/iso/ISOComponent;Ljava/io/InputStream;)V
    ...
    invoke-virtual {p0, p2, v2}, Lorg/jpos/iso/IFB_BITMAP;->readBytes(Ljava/io/InputStream;I)[B

    move-result-object v3

    const/4 v4, 0x0

    invoke-static {v0, v3, v4}, Lorg/jpos/iso/ISOUtil;->byte2BitSet(Ljava/util/BitSet;[BI)Ljava/util/BitSet;
    ...
    invoke-static {v0, v3, v1}, Lorg/jpos/iso/ISOUtil;->byte2BitSet(Ljava/util/BitSet;[BI)Ljava/util/BitSet;
    ...
    invoke-static {v0, v1, v2}, Lorg/jpos/iso/ISOUtil;->byte2BitSet(Ljava/util/BitSet;[BI)Ljava/util/BitSet;
