.class public Lorg/jpos/iso/ISOAmountFieldPackager;
.super Lorg/jpos/iso/ISOFieldPackager;
.source "ISOAmountFieldPackager.java"
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/jpos/iso/ISOAmountFieldPackager;->padder:Lorg/jpos/iso/Padder;

    .line 60
    sget-object v0, Lorg/jpos/iso/LiteralInterpreter;->INSTANCE:Lorg/jpos/iso/LiteralInterpreter;

    iput-object v0, p0, Lorg/jpos/iso/ISOAmountFieldPackager;->interpreter:Lorg/jpos/iso/Interpreter;

    .line 61
    sget-object v0, Lorg/jpos/iso/NullPrefixer;->INSTANCE:Lorg/jpos/iso/NullPrefixer;

    iput-object v0, p0, Lorg/jpos/iso/ISOAmountFieldPackager;->prefixer:Lorg/jpos/iso/Prefixer;
...
.method public constructor <init>(ILjava/lang/String;Lorg/jpos/iso/Padder;Lorg/jpos/iso/Interpreter;Lorg/jpos/iso/Prefixer;)V
    ...
    .line 46
    iput-object p3, p0, Lorg/jpos/iso/ISOAmountFieldPackager;->padder:Lorg/jpos/iso/Padder;

    .line 47
    iput-object p4, p0, Lorg/jpos/iso/ISOAmountFieldPackager;->interpreter:Lorg/jpos/iso/Interpreter;

    .line 48
    iput-object p5, p0, Lorg/jpos/iso/ISOAmountFieldPackager;->prefixer:Lorg/jpos/iso/Prefixer;
...
.method public constructor <init>(Lorg/jpos/iso/Padder;Lorg/jpos/iso/Interpreter;Lorg/jpos/iso/Prefixer;)V
    ...
    .line 74
    iput-object p1, p0, Lorg/jpos/iso/ISOAmountFieldPackager;->padder:Lorg/jpos/iso/Padder;

    .line 75
    iput-object p2, p0, Lorg/jpos/iso/ISOAmountFieldPackager;->interpreter:Lorg/jpos/iso/Interpreter;

    .line 76
    iput-object p3, p0, Lorg/jpos/iso/ISOAmountFieldPackager;->prefixer:Lorg/jpos/iso/Prefixer;
...
.method public getMaxPackedLength()I
    ...
    .line 111
    iget-object v0, p0, Lorg/jpos/iso/ISOAmountFieldPackager;->prefixer:Lorg/jpos/iso/Prefixer;

    invoke-interface {v0}, Lorg/jpos/iso/Prefixer;->getPackedLength()I

    move-result v0

    iget-object v1, p0, Lorg/jpos/iso/ISOAmountFieldPackager;->interpreter:Lorg/jpos/iso/Interpreter;

    invoke-virtual {p0}, Lorg/jpos/iso/ISOAmountFieldPackager;->getLength()I
...
.method public pack(Lorg/jpos/iso/ISOComponent;)[B
    ...
    iget-object v4, p0, Lorg/jpos/iso/ISOAmountFieldPackager;->padder:Lorg/jpos/iso/Padder;
    ...
    invoke-interface {v4, v3, v5}, Lorg/jpos/iso/Padder;->pad(Ljava/lang/String;I)Ljava/lang/String;

    move-result-object v4

    .line 144
    .local v4, "paddedData":Ljava/lang/String;
    iget-object v5, p0, Lorg/jpos/iso/ISOAmountFieldPackager;->interpreter:Lorg/jpos/iso/Interpreter;

    invoke-interface {v5, v2}, Lorg/jpos/iso/Interpreter;->getPackedLength(I)I

    move-result v2

    .line 145
    .local v2, "signLength":I
    iget-object v5, p0, Lorg/jpos/iso/ISOAmountFieldPackager;->prefixer:Lorg/jpos/iso/Prefixer;
    ...
    iget-object v6, p0, Lorg/jpos/iso/ISOAmountFieldPackager;->interpreter:Lorg/jpos/iso/Interpreter;
    ...
    invoke-interface {v6, v7}, Lorg/jpos/iso/Interpreter;->getPackedLength(I)I
    ...
    .line 148
    .local v5, "rawData":[B
    iget-object v6, p0, Lorg/jpos/iso/ISOAmountFieldPackager;->prefixer:Lorg/jpos/iso/Prefixer;

    invoke-virtual {v4}, Ljava/lang/String;->length()I

    move-result v7

    invoke-interface {v6, v7, v5}, Lorg/jpos/iso/Prefixer;->encodeLength(I[B)V

    .line 149
    iget-object v6, p0, Lorg/jpos/iso/ISOAmountFieldPackager;->interpreter:Lorg/jpos/iso/Interpreter;

    iget-object v7, p0, Lorg/jpos/iso/ISOAmountFieldPackager;->prefixer:Lorg/jpos/iso/Prefixer;

    invoke-interface {v7}, Lorg/jpos/iso/Prefixer;->getPackedLength()I

    move-result v7

    invoke-interface {v6, v1, v5, v7}, Lorg/jpos/iso/Interpreter;->interpret(Ljava/lang/String;[BI)V
    ...
    invoke-interface {v6, v4, v5, v7}, Lorg/jpos/iso/Interpreter;->interpret(Ljava/lang/String;[BI)V
    ...
    .end local v2    # "signLength":I
    .end local v3    # "amount":Ljava/lang/String;
    .end local v4    # "paddedData":Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v2}, Lorg/jpos/iso/ISOAmountFieldPackager;->makeExceptionMessage(Lorg/jpos/iso/ISOComponent;Ljava/lang/String;)Ljava/lang/String;
...
.method public setInterpreter(Lorg/jpos/iso/Interpreter;)V
    ...
    .line 94
    iput-object p1, p0, Lorg/jpos/iso/ISOAmountFieldPackager;->interpreter:Lorg/jpos/iso/Interpreter;
...
.method public setPrefixer(Lorg/jpos/iso/Prefixer;)V
    ...
    .line 103
    iput-object p1, p0, Lorg/jpos/iso/ISOAmountFieldPackager;->prefixer:Lorg/jpos/iso/Prefixer;
...
.method public unpack(Lorg/jpos/iso/ISOComponent;[BI)I
    ...
    :cond_2
    :goto_0
    iget-object v1, p0, Lorg/jpos/iso/ISOAmountFieldPackager;->prefixer:Lorg/jpos/iso/Prefixer;
    ...
    .line 178
    .local v1, "lenLen":I
    iget-object v2, p0, Lorg/jpos/iso/ISOAmountFieldPackager;->interpreter:Lorg/jpos/iso/Interpreter;
    ...
    .line 180
    iget-object v3, p0, Lorg/jpos/iso/ISOAmountFieldPackager;->interpreter:Lorg/jpos/iso/Interpreter;
...
.method public unpack(Lorg/jpos/iso/ISOComponent;Ljava/io/InputStream;)V
    ...
    .end local v2    # "len":I
    :cond_0
    iget-object v2, p0, Lorg/jpos/iso/ISOAmountFieldPackager;->prefixer:Lorg/jpos/iso/Prefixer;

    invoke-virtual {p0, p2, v0}, Lorg/jpos/iso/ISOAmountFieldPackager;->readBytes(Ljava/io/InputStream;I)[B
    ...
    iget-object v4, p0, Lorg/jpos/iso/ISOAmountFieldPackager;->interpreter:Lorg/jpos/iso/Interpreter;

    invoke-virtual {p0, p2, v3}, Lorg/jpos/iso/ISOAmountFieldPackager;->readBytes(Ljava/io/InputStream;I)[B
