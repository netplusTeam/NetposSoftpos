...
.method private isElement(Ljava/lang/String;)Z
    ...
    .line 373
    .local v5, "element":Lorg/simpleframework/xml/core/Model;
    ...
    .end local v5    # "element":Lorg/simpleframework/xml/core/Model;
    :cond_2
    return v2
.end method
...
.method private union(Lorg/simpleframework/xml/core/Contact;Ljava/lang/annotation/Annotation;Lorg/simpleframework/xml/core/LabelMap;)V
    ...
    .line 220
    .local v0, "list":Ljava/util/List;, "Ljava/util/List<Lorg/simpleframework/xml/core/Label;>;"
...
.method private validateAttributes(Ljava/lang/Class;Lorg/simpleframework/xml/Order;)V
    ...
    const-string v6, "Ordered attribute \'%s\' missing in %s"
...
.method private validateElements(Ljava/lang/Class;Lorg/simpleframework/xml/Order;)V
    ...
    const-string v6, "Ordered element \'%s\' missing for %s"
...
.method private validateTextList(Ljava/lang/Class;)V
    ...
    .line 562
    .local v3, "element":Lorg/simpleframework/xml/core/Label;
    invoke-interface {v3}, Lorg/simpleframework/xml/core/Label;->getKey()Ljava/lang/Object;

    move-result-object v7

    .line 564
    .local v7, "identity":Ljava/lang/Object;
    ...
    .line 568
    .local v8, "dependent":Lorg/simpleframework/xml/strategy/Type;
    invoke-interface {v8}, Lorg/simpleframework/xml/strategy/Type;->getType()Ljava/lang/Class;

    move-result-object v9

    .line 570
    .local v9, "actual":Ljava/lang/Class;
    const-class v10, Ljava/lang/String;

    if-eq v9, v10, :cond_0

    .line 573
    .end local v3    # "element":Lorg/simpleframework/xml/core/Label;
    .end local v7    # "identity":Ljava/lang/Object;
    .end local v8    # "dependent":Lorg/simpleframework/xml/strategy/Type;
    .end local v9    # "actual":Ljava/lang/Class;
    goto :goto_0

    .line 571
    .restart local v3    # "element":Lorg/simpleframework/xml/core/Label;
    .restart local v7    # "identity":Ljava/lang/Object;
    .restart local v8    # "dependent":Lorg/simpleframework/xml/strategy/Type;
    .restart local v9    # "actual":Ljava/lang/Class;
    :cond_0
    ...
    invoke-direct {v8, v4, v6}, Lorg/simpleframework/xml/core/TextException;-><init>(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private validateUnions(Ljava/lang/Class;)V
    ...
    .line 594
    .local v4, "contact":Lorg/simpleframework/xml/core/Contact;
    move-object v5, v3
    ...
    iget-object v10, v0, Lorg/simpleframework/xml/core/StructureBuilder;->elements:Lorg/simpleframework/xml/core/LabelMap;

    invoke-virtual {v10, v8}, Lorg/simpleframework/xml/core/LabelMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v10

    check-cast v10, Lorg/simpleframework/xml/core/Label;

    .line 598
    .local v10, "other":Lorg/simpleframework/xml/core/Label;
    invoke-interface {v2}, Lorg/simpleframework/xml/core/Label;->isInline()Z

    move-result v11

    invoke-interface {v10}, Lorg/simpleframework/xml/core/Label;->isInline()Z
    ...
    .end local v10    # "other":Lorg/simpleframework/xml/core/Label;
    ...
    .restart local v9    # "union":Ljava/lang/annotation/Annotation;
    .restart local v10    # "other":Lorg/simpleframework/xml/core/Label;
    :cond_0
    new-instance v11, Lorg/simpleframework/xml/core/UnionException;
    ...
    const-string v13, "Required must be consistent in %s for %s"

    invoke-direct {v11, v13, v12}, Lorg/simpleframework/xml/core/UnionException;-><init>(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string v13, "Inline must be consistent in %s for %s"
    ...
    .line 605
    .end local v2    # "label":Lorg/simpleframework/xml/core/Label;
    .end local v3    # "options":[Ljava/lang/String;
    .end local v4    # "contact":Lorg/simpleframework/xml/core/Contact;
