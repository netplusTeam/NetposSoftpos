...
.method public constructor <init>(Ljava/io/File;)V
    ...
    iput-object v1, p0, Lpl/droidsonroids/relinker/elf/ElfParser;->channel:Ljava/nio/channels/FileChannel;
...
.method private offsetFromVma(Lpl/droidsonroids/relinker/elf/Elf$Header;JJ)J
    .locals 9
    .param p1, "header"    # Lpl/droidsonroids/relinker/elf/Elf$Header;
    ...
    .line 132
    .local v2, "programHeader":Lpl/droidsonroids/relinker/elf/Elf$ProgramHeader;
    ...
    iget-wide v5, v2, Lpl/droidsonroids/relinker/elf/Elf$ProgramHeader;->offset:J
    ...
    .line 130
    .end local v2    # "programHeader":Lpl/droidsonroids/relinker/elf/Elf$ProgramHeader;
    :cond_0
...
.method public parseHeader()Lpl/droidsonroids/relinker/elf/Elf$Header;
    ...
    .line 57
    new-instance v3, Lpl/droidsonroids/relinker/elf/Elf32Header;

    invoke-direct {v3, v2, p0}, Lpl/droidsonroids/relinker/elf/Elf32Header;-><init>(ZLpl/droidsonroids/relinker/elf/ElfParser;)V
    ...
    .line 59
    new-instance v3, Lpl/droidsonroids/relinker/elf/Elf64Header;

    invoke-direct {v3, v2, p0}, Lpl/droidsonroids/relinker/elf/Elf64Header;-><init>(ZLpl/droidsonroids/relinker/elf/ElfParser;)V
...
.method public parseNeededDependencies()Ljava/util/List;
    ...
    .line 69
    .local v8, "header":Lpl/droidsonroids/relinker/elf/Elf$Header;
    const/16 v0, 0x8
    ...
    iget-boolean v0, v8, Lpl/droidsonroids/relinker/elf/Elf$Header;->bigEndian:Z
    ...
    .line 72
    iget v0, v8, Lpl/droidsonroids/relinker/elf/Elf$Header;->phnum:I
    ...
    invoke-virtual {v8, v0}, Lpl/droidsonroids/relinker/elf/Elf$Header;->getSectionHeader(I)Lpl/droidsonroids/relinker/elf/Elf$SectionHeader;

    move-result-object v0

    .line 84
    .local v0, "sectionHeader":Lpl/droidsonroids/relinker/elf/Elf$SectionHeader;
    iget-wide v3, v0, Lpl/droidsonroids/relinker/elf/Elf$SectionHeader;->info:J
    ...
    .line 73
    .end local v0    # "sectionHeader":Lpl/droidsonroids/relinker/elf/Elf$SectionHeader;
    :cond_1
    move-wide v10, v3
    ...
    .line 89
    invoke-virtual {v8, v12, v13}, Lpl/droidsonroids/relinker/elf/Elf$Header;->getProgramHeader(J)Lpl/droidsonroids/relinker/elf/Elf$ProgramHeader;

    move-result-object v0

    .line 90
    .local v0, "programHeader":Lpl/droidsonroids/relinker/elf/Elf$ProgramHeader;
    iget-wide v1, v0, Lpl/droidsonroids/relinker/elf/Elf$ProgramHeader;->type:J
    ...
    .line 91
    iget-wide v3, v0, Lpl/droidsonroids/relinker/elf/Elf$ProgramHeader;->offset:J
    ...
    .line 88
    .end local v0    # "programHeader":Lpl/droidsonroids/relinker/elf/Elf$ProgramHeader;
    :cond_2
    ...
    :goto_4
    invoke-virtual {v8, v12, v13, v0}, Lpl/droidsonroids/relinker/elf/Elf$Header;->getDynamicStructure(JI)Lpl/droidsonroids/relinker/elf/Elf$DynamicStructure;

    move-result-object v5

    .line 107
    .local v5, "dynStructure":Lpl/droidsonroids/relinker/elf/Elf$DynamicStructure;
    move-wide/from16 v18, v1

    .end local v1    # "vStringTableOff":J
    .local v18, "vStringTableOff":J
    iget-wide v1, v5, Lpl/droidsonroids/relinker/elf/Elf$DynamicStructure;->tag:J
    ...
    .line 108
    iget-wide v1, v5, Lpl/droidsonroids/relinker/elf/Elf$DynamicStructure;->val:J
    ...
    .end local v0    # "i":I
    .local v20, "i":I
    iget-wide v0, v5, Lpl/droidsonroids/relinker/elf/Elf$DynamicStructure;->tag:J
    ...
    .end local v5    # "dynStructure":Lpl/droidsonroids/relinker/elf/Elf$DynamicStructure;
    .local v16, "neededOffsets":Ljava/util/List;, "Ljava/util/List<Ljava/lang/Long;>;"
    .local v17, "dynStructure":Lpl/droidsonroids/relinker/elf/Elf$DynamicStructure;
    ...
    invoke-virtual {v6, v9, v4, v5}, Lpl/droidsonroids/relinker/elf/ElfParser;->readString(Ljava/nio/ByteBuffer;J)Ljava/lang/String;
    ...
    .end local v17    # "dynStructure":Lpl/droidsonroids/relinker/elf/Elf$DynamicStructure;
    .restart local v4    # "neededOffsets":Ljava/util/List;, "Ljava/util/List<Ljava/lang/Long;>;"
    .restart local v5    # "dynStructure":Lpl/droidsonroids/relinker/elf/Elf$DynamicStructure;
    :cond_8
    new-instance v0, Ljava/lang/IllegalStateException;
    ...
    .restart local v17    # "dynStructure":Lpl/droidsonroids/relinker/elf/Elf$DynamicStructure;
