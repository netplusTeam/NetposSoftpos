...
.method static constructor <clinit>()V
    ...
    .line 247
    .local v1, "accFieldName":Ljava/lang/String;
    :goto_0
    const-class v2, Ljava/lang/Thread;
    ...
    sput-wide v2, Ljava9/util/concurrent/TLRandom;->INHERITEDACCESSCONTROLCONTEXT:J

    .line 250
    const-class v2, Ljava/lang/Thread;

    const-string v3, "contextClassLoader"
    ...
    sput-wide v2, Ljava9/util/concurrent/TLRandom;->CCL:J

    .line 252
    .end local v1    # "accFieldName":Ljava/lang/String;
    goto :goto_1
...
.method private static isClassPresent(Ljava/lang/String;)Z
    ...
    :try_start_0
    const-class v2, Ljava9/util/concurrent/TLRandom;
...
.method static final localInit()V
    ...
    .local v1, "probe":I
    :goto_0
    sget-object v2, Ljava9/util/concurrent/TLRandom;->seeder:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    .line 47
    .local v2, "seed":J
    invoke-static {v2, v3}, Ljava9/util/concurrent/TLRandom;->setThreadLocalRandomSeed(J)V

    .line 48
    invoke-static {v1}, Ljava9/util/concurrent/TLRandom;->setThreadLocalRandomProbe(I)V
...
.method static final setContextClassLoader(Ljava/lang/Thread;Ljava/lang/ClassLoader;)V
    .locals 3
    .param p0, "thread"    # Ljava/lang/Thread;
    .param p1, "ccl"    # Ljava/lang/ClassLoader;
