...
.method constructor <init>(Ljava9/util/stream/PipelineHelper;Ljava9/util/Spliterator;Z)V
    ...
    .line 284
    .local p0, "this":Ljava9/util/stream/StreamSpliterators$WrappingSpliterator;, "Ljava9/util/stream/StreamSpliterators$WrappingSpliterator<TP_IN;TP_OUT;>;"
...
.method public forEachRemaining(Ljava9/util/function/Consumer;)V
    ...
    .line 311
    .local p0, "this":Ljava9/util/stream/StreamSpliterators$WrappingSpliterator;, "Ljava9/util/stream/StreamSpliterators$WrappingSpliterator<TP_IN;TP_OUT;>;"
    .local p1, "consumer":Ljava9/util/function/Consumer;, "Ljava9/util/function/Consumer<-TP_OUT;>;"
    ...
    iget-object v2, p0, Ljava9/util/stream/StreamSpliterators$WrappingSpliterator;->spliterator:Ljava9/util/Spliterator;
    ...
    iput-boolean v0, p0, Ljava9/util/stream/StreamSpliterators$WrappingSpliterator;->finished:Z
...
.method initPartialTraversalState()V
    ...
    .line 295
    .local v0, "b":Ljava9/util/stream/SpinedBuffer;, "Ljava9/util/stream/SpinedBuffer<TP_OUT;>;"
    ...
    iput-object v1, p0, Ljava9/util/stream/StreamSpliterators$WrappingSpliterator;->bufferSink:Ljava9/util/stream/Sink;

    .line 297
    new-instance v1, Ljava9/util/stream/StreamSpliterators$WrappingSpliterator$$ExternalSyntheticLambda2;

    invoke-direct {v1, p0}, Ljava9/util/stream/StreamSpliterators$WrappingSpliterator$$ExternalSyntheticLambda2;-><init>(Ljava9/util/stream/StreamSpliterators$WrappingSpliterator;)V

    iput-object v1, p0, Ljava9/util/stream/StreamSpliterators$WrappingSpliterator;->pusher:Ljava9/util/function/BooleanSupplier;

    .line 298
    return-void
.end method

.method synthetic lambda$initPartialTraversalState$61$java9-util-stream-StreamSpliterators$WrappingSpliterator()Z
    .locals 2
