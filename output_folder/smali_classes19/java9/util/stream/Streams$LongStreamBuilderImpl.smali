...
.method public build()Ljava9/util/stream/LongStream;
    ...
    :cond_0
    iget-object v1, p0, Ljava9/util/stream/Streams$LongStreamBuilderImpl;->buffer:Ljava9/util/stream/SpinedBuffer$OfLong;

    invoke-virtual {v1}, Ljava9/util/stream/SpinedBuffer$OfLong;->spliterator()Ljava9/util/Spliterator$OfLong;

    move-result-object v1

    invoke-static {v1, v2}, Ljava9/util/stream/StreamSupport;->longStream(Ljava9/util/Spliterator$OfLong;Z)Ljava9/util/stream/LongStream;
