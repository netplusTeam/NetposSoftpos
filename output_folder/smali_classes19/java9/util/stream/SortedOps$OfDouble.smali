...
.method public opEvaluateParallel(Ljava9/util/stream/PipelineHelper;Ljava9/util/Spliterator;Ljava9/util/function/IntFunction;)Ljava9/util/stream/Node;
    ...
    .line 276
    .local v0, "n":Ljava9/util/stream/Node$OfDouble;
    ...
    .line 277
    .local v1, "content":[D
    invoke-static {v1}, Ljava9/util/J8Arrays;->parallelSort([D)V

    .line 279
    invoke-static {v1}, Ljava9/util/stream/Nodes;->node([D)Ljava9/util/stream/Node$OfDouble;
...
.method public opWrapSink(ILjava9/util/stream/Sink;)Ljava9/util/stream/Sink;
    ...
    .line 261
    new-instance v0, Ljava9/util/stream/SortedOps$SizedDoubleSortingSink;

    invoke-direct {v0, p2}, Ljava9/util/stream/SortedOps$SizedDoubleSortingSink;-><init>(Ljava9/util/stream/Sink;)V

    return-object v0

    .line 263
    :cond_1
    new-instance v0, Ljava9/util/stream/SortedOps$DoubleSortingSink;

    invoke-direct {v0, p2}, Ljava9/util/stream/SortedOps$DoubleSortingSink;-><init>(Ljava9/util/stream/Sink;)V
