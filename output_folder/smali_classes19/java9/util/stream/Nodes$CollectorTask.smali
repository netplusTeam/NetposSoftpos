...
.method constructor <init>(Ljava9/util/stream/Nodes$CollectorTask;Ljava9/util/Spliterator;)V
    ...
    .line 2119
    .local p0, "this":Ljava9/util/stream/Nodes$CollectorTask;, "Ljava9/util/stream/Nodes$CollectorTask<TP_IN;TP_OUT;TT_NODE;TT_BUILDER;>;"
    .local p1, "parent":Ljava9/util/stream/Nodes$CollectorTask;, "Ljava9/util/stream/Nodes$CollectorTask<TP_IN;TP_OUT;TT_NODE;TT_BUILDER;>;"
    ...
    .line 2120
    iget-object v0, p1, Ljava9/util/stream/Nodes$CollectorTask;->helper:Ljava9/util/stream/PipelineHelper;

    iput-object v0, p0, Ljava9/util/stream/Nodes$CollectorTask;->helper:Ljava9/util/stream/PipelineHelper;

    .line 2121
    iget-object v0, p1, Ljava9/util/stream/Nodes$CollectorTask;->builderFactory:Ljava9/util/function/LongFunction;

    iput-object v0, p0, Ljava9/util/stream/Nodes$CollectorTask;->builderFactory:Ljava9/util/function/LongFunction;

    .line 2122
    iget-object v0, p1, Ljava9/util/stream/Nodes$CollectorTask;->concFactory:Ljava9/util/function/BinaryOperator;

    iput-object v0, p0, Ljava9/util/stream/Nodes$CollectorTask;->concFactory:Ljava9/util/function/BinaryOperator;
...
.method constructor <init>(Ljava9/util/stream/PipelineHelper;Ljava9/util/Spliterator;Ljava9/util/function/LongFunction;Ljava9/util/function/BinaryOperator;)V
    ...
    .local p2, "spliterator":Ljava9/util/Spliterator;, "Ljava9/util/Spliterator<TP_IN;>;"
    .local p3, "builderFactory":Ljava9/util/function/LongFunction;, "Ljava9/util/function/LongFunction<TT_BUILDER;>;"
    .local p4, "concFactory":Ljava9/util/function/BinaryOperator;, "Ljava9/util/function/BinaryOperator<TT_NODE;>;"
...
.method protected doLeaf()Ljava9/util/stream/Node;
    ...
    .line 2134
    .local v0, "builder":Ljava9/util/stream/Node$Builder;, "TT_BUILDER;"
    iget-object v1, p0, Ljava9/util/stream/Nodes$CollectorTask;->helper:Ljava9/util/stream/PipelineHelper;
