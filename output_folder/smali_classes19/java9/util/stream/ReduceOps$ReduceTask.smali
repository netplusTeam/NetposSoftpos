...
.method constructor <init>(Ljava9/util/stream/ReduceOps$ReduceOp;Ljava9/util/stream/PipelineHelper;Ljava9/util/Spliterator;)V
    ...
    .line 935
    .local p0, "this":Ljava9/util/stream/ReduceOps$ReduceTask;, "Ljava9/util/stream/ReduceOps$ReduceTask<TP_IN;TP_OUT;TR;TS;>;"
    .local p1, "op":Ljava9/util/stream/ReduceOps$ReduceOp;, "Ljava9/util/stream/ReduceOps$ReduceOp<TP_OUT;TR;TS;>;"
...
.method constructor <init>(Ljava9/util/stream/ReduceOps$ReduceTask;Ljava9/util/Spliterator;)V
    ...
    .line 941
    .local p0, "this":Ljava9/util/stream/ReduceOps$ReduceTask;, "Ljava9/util/stream/ReduceOps$ReduceTask<TP_IN;TP_OUT;TR;TS;>;"
    .local p1, "parent":Ljava9/util/stream/ReduceOps$ReduceTask;, "Ljava9/util/stream/ReduceOps$ReduceTask<TP_IN;TP_OUT;TR;TS;>;"
    ...
    .line 942
    iget-object v0, p1, Ljava9/util/stream/ReduceOps$ReduceTask;->op:Ljava9/util/stream/ReduceOps$ReduceOp;

    iput-object v0, p0, Ljava9/util/stream/ReduceOps$ReduceTask;->op:Ljava9/util/stream/ReduceOps$ReduceOp;
...
.method public onCompletion(Ljava9/util/concurrent/CountedCompleter;)V
    ...
    .line 959
    .local v0, "leftResult":Ljava9/util/stream/ReduceOps$AccumulatingSink;, "TS;"
    ...
    .line 963
    .end local v0    # "leftResult":Ljava9/util/stream/ReduceOps$AccumulatingSink;, "TS;"
    :cond_0
