...
.method public static makeDouble(Z)Ljava9/util/stream/TerminalOp;
    ...
    sget-object v0, Ljava9/util/stream/FindOps;->FIRST_DOUBLE:Ljava9/util/stream/TerminalOp;

    goto :goto_0

    :cond_0
    sget-object v0, Ljava9/util/stream/FindOps;->ANY_DOUBLE:Ljava9/util/stream/TerminalOp;
...
.method public static makeInt(Z)Ljava9/util/stream/TerminalOp;
    ...
    sget-object v0, Ljava9/util/stream/FindOps;->FIRST_INT:Ljava9/util/stream/TerminalOp;

    goto :goto_0

    :cond_0
    sget-object v0, Ljava9/util/stream/FindOps;->ANY_INT:Ljava9/util/stream/TerminalOp;
...
.method public static makeLong(Z)Ljava9/util/stream/TerminalOp;
    ...
    sget-object v0, Ljava9/util/stream/FindOps;->FIRST_LONG:Ljava9/util/stream/TerminalOp;

    goto :goto_0

    :cond_0
    sget-object v0, Ljava9/util/stream/FindOps;->ANY_LONG:Ljava9/util/stream/TerminalOp;
...
.method public static makeRef(Z)Ljava9/util/stream/TerminalOp;
    ...
    sget-object v0, Ljava9/util/stream/FindOps;->FIRST_REF:Ljava9/util/stream/TerminalOp;

    goto :goto_0

    :cond_0
    sget-object v0, Ljava9/util/stream/FindOps;->ANY_REF:Ljava9/util/stream/TerminalOp;
