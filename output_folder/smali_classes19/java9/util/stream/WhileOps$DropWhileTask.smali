...
.method constructor <init>(Ljava9/util/stream/AbstractPipeline;Ljava9/util/stream/PipelineHelper;Ljava9/util/Spliterator;Ljava9/util/function/IntFunction;)V
    ...
    .line 1315
    .local p0, "this":Ljava9/util/stream/WhileOps$DropWhileTask;, "Ljava9/util/stream/WhileOps$DropWhileTask<TP_IN;TP_OUT;>;"
    ...
    iput-boolean v0, p0, Ljava9/util/stream/WhileOps$DropWhileTask;->isOrdered:Z
...
.method constructor <init>(Ljava9/util/stream/WhileOps$DropWhileTask;Ljava9/util/Spliterator;)V
    ...
    .line 1322
    .local p0, "this":Ljava9/util/stream/WhileOps$DropWhileTask;, "Ljava9/util/stream/WhileOps$DropWhileTask<TP_IN;TP_OUT;>;"
    .local p1, "parent":Ljava9/util/stream/WhileOps$DropWhileTask;, "Ljava9/util/stream/WhileOps$DropWhileTask<TP_IN;TP_OUT;>;"
    ...
    .line 1323
    iget-object v0, p1, Ljava9/util/stream/WhileOps$DropWhileTask;->op:Ljava9/util/stream/AbstractPipeline;

    iput-object v0, p0, Ljava9/util/stream/WhileOps$DropWhileTask;->op:Ljava9/util/stream/AbstractPipeline;

    .line 1324
    iget-object v0, p1, Ljava9/util/stream/WhileOps$DropWhileTask;->generator:Ljava9/util/function/IntFunction;

    iput-object v0, p0, Ljava9/util/stream/WhileOps$DropWhileTask;->generator:Ljava9/util/function/IntFunction;

    .line 1325
    iget-boolean v0, p1, Ljava9/util/stream/WhileOps$DropWhileTask;->isOrdered:Z
...
.method protected final doLeaf()Ljava9/util/stream/Node;
    ...
    .line 1343
    .local v4, "builder":Ljava9/util/stream/Node$Builder;, "Ljava9/util/stream/Node$Builder<TP_OUT;>;"
    iget-object v5, p0, Ljava9/util/stream/WhileOps$DropWhileTask;->op:Ljava9/util/stream/AbstractPipeline;

    check-cast v5, Ljava9/util/stream/WhileOps$DropWhileOp;

    .line 1346
    .local v5, "dropOp":Ljava9/util/stream/WhileOps$DropWhileOp;, "Ljava9/util/stream/WhileOps$DropWhileOp<TP_OUT;>;"
    iget-boolean v6, p0, Ljava9/util/stream/WhileOps$DropWhileTask;->isOrdered:Z
    ...
    :goto_1
    invoke-interface {v5, v4, v1}, Ljava9/util/stream/WhileOps$DropWhileOp;->opWrapSink(Ljava9/util/stream/Sink;Z)Ljava9/util/stream/WhileOps$DropWhileSink;

    move-result-object v1

    .line 1347
    .local v1, "s":Ljava9/util/stream/WhileOps$DropWhileSink;, "Ljava9/util/stream/WhileOps$DropWhileSink<TP_OUT;>;"
    iget-object v6, p0, Ljava9/util/stream/WhileOps$DropWhileTask;->helper:Ljava9/util/stream/PipelineHelper;

    iget-object v7, p0, Ljava9/util/stream/WhileOps$DropWhileTask;->spliterator:Ljava9/util/Spliterator;

    invoke-virtual {v6, v1, v7}, Ljava9/util/stream/PipelineHelper;->wrapAndCopyInto(Ljava9/util/stream/Sink;Ljava9/util/Spliterator;)Ljava9/util/stream/Sink;

    .line 1349
    invoke-interface {v4}, Ljava9/util/stream/Node$Builder;->build()Ljava9/util/stream/Node;

    move-result-object v6

    .line 1350
    .local v6, "node":Ljava9/util/stream/Node;, "Ljava9/util/stream/Node<TP_OUT;>;"
    invoke-interface {v6}, Ljava9/util/stream/Node;->count()J

    move-result-wide v7

    iput-wide v7, p0, Ljava9/util/stream/WhileOps$DropWhileTask;->thisNodeSize:J

    .line 1351
    invoke-interface {v1}, Ljava9/util/stream/WhileOps$DropWhileSink;->getDropCount()J

    move-result-wide v7

    iput-wide v7, p0, Ljava9/util/stream/WhileOps$DropWhileTask;->index:J
...
.method public final onCompletion(Ljava9/util/concurrent/CountedCompleter;)V
    ...
    :goto_0
    invoke-virtual {p0, v1}, Ljava9/util/stream/WhileOps$DropWhileTask;->setLocalResult(Ljava/lang/Object;)V
