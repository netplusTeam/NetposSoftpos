...
.method static constructor <clinit>()V
    ...
    .line 65
    const-string v2, "io.netty.recycler.maxCapacityPerThread"
    ...
    .line 67
    .local v1, "maxCapacityPerThread":I
    if-gez v1, :cond_0
    ...
    .line 71
    :cond_0
    sput v1, Lio/netty/util/Recycler;->DEFAULT_MAX_CAPACITY_PER_THREAD:I

    .line 73
    nop

    .line 74
    const-string v2, "io.netty.recycler.maxSharedCapacityFactor"
    ...
    sput v2, Lio/netty/util/Recycler;->MAX_SHARED_CAPACITY_FACTOR:I
    ...
    .line 93
    const-string v2, "-Dio.netty.recycler.maxSharedCapacityFactor: disabled"

    invoke-interface {v0, v2}, Lio/netty/util/internal/logging/InternalLogger;->debug(Ljava/lang/String;)V

    .line 94
    const-string v2, "-Dio.netty.recycler.linkCapacity: disabled"
    ...
    .line 228
    .end local v1    # "maxCapacityPerThread":I
...
.method protected constructor <init>(IIII)V
    ...
    iput v0, p0, Lio/netty/util/Recycler;->interval:I
    ...
    .line 146
    iput v1, p0, Lio/netty/util/Recycler;->maxCapacityPerThread:I

    .line 147
    iput v0, p0, Lio/netty/util/Recycler;->maxSharedCapacityFactor:I

    .line 148
    iput v1, p0, Lio/netty/util/Recycler;->maxDelayedQueuesPerThread:I
...
.method static synthetic access$100(Lio/netty/util/Recycler;)I
    ...
    .line 40
    iget v0, p0, Lio/netty/util/Recycler;->maxSharedCapacityFactor:I
...
.method static synthetic access$300(Lio/netty/util/Recycler;)I
    ...
    .line 40
    iget v0, p0, Lio/netty/util/Recycler;->maxDelayedQueuesPerThread:I
...
.method public final get()Ljava/lang/Object;
    ...
    .line 162
    .local v0, "stack":Lio/netty/util/Recycler$Stack;, "Lio/netty/util/Recycler$Stack<TT;>;"
    ...
    iput-object v2, v1, Lio/netty/util/Recycler$DefaultHandle;->value:Ljava/lang/Object;

    .line 167
    :cond_1
    iget-object v2, v1, Lio/netty/util/Recycler$DefaultHandle;->value:Ljava/lang/Object;
...
.method public final recycle(Ljava/lang/Object;Lio/netty/util/Recycler$Handle;)Z
    ...
    .line 180
    .local v0, "h":Lio/netty/util/Recycler$DefaultHandle;, "Lio/netty/util/Recycler$DefaultHandle<TT;>;"
    iget-object v2, v0, Lio/netty/util/Recycler$DefaultHandle;->stack:Lio/netty/util/Recycler$Stack;

    iget-object v2, v2, Lio/netty/util/Recycler$Stack;->parent:Lio/netty/util/Recycler;
    ...
    .line 184
    :cond_1
    invoke-virtual {v0, p1}, Lio/netty/util/Recycler$DefaultHandle;->recycle(Ljava/lang/Object;)V
