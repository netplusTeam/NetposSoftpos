...
.method static constructor <clinit>()V
    ...
    const-string v2, "io.netty.serviceThreadPrefix"
    ...
    .line 63
    .local v2, "serviceThreadPrefix":Ljava/lang/String;
    invoke-static {v2}, Lio/netty/util/internal/StringUtil;->isNullOrEmpty(Ljava/lang/String;)Z
    ...
    .line 69
    :cond_0
    new-instance v3, Lio/netty/util/concurrent/DefaultThreadFactory;

    const/4 v4, 0x1

    invoke-direct {v3, v0, v4, v4, v1}, Lio/netty/util/concurrent/DefaultThreadFactory;-><init>(Ljava/lang/String;ZILjava/lang/ThreadGroup;)V

    sput-object v3, Lio/netty/util/ThreadDeathWatcher;->threadFactory:Ljava/util/concurrent/ThreadFactory;

    .line 70
    .end local v0    # "poolName":Ljava/lang/String;
    .end local v2    # "serviceThreadPrefix":Ljava/lang/String;
    return-void
.end method
...
.method private static schedule(Ljava/lang/Thread;Ljava/lang/Runnable;Z)V
    ...
    .line 104
    sget-object v0, Lio/netty/util/ThreadDeathWatcher;->threadFactory:Ljava/util/concurrent/ThreadFactory;

    sget-object v1, Lio/netty/util/ThreadDeathWatcher;->watcher:Lio/netty/util/ThreadDeathWatcher$Watcher;
    ...
    .line 110
    .local v0, "watcherThread":Ljava/lang/Thread;
    new-instance v1, Lio/netty/util/ThreadDeathWatcher$1;

    invoke-direct {v1, v0}, Lio/netty/util/ThreadDeathWatcher$1;-><init>(Ljava/lang/Thread;)V
...
.method public static unwatch(Ljava/lang/Thread;Ljava/lang/Runnable;)V
    ...
    invoke-static {v0, v1, v2}, Lio/netty/util/ThreadDeathWatcher;->schedule(Ljava/lang/Thread;Ljava/lang/Runnable;Z)V
