...
.method private constructor <init>(Lio/netty/util/collection/ShortObjectHashMap;)V
    ...
    .line 534
    .local p0, "this":Lio/netty/util/collection/ShortObjectHashMap$KeySet;, "Lio/netty/util/collection/ShortObjectHashMap<TV;>.KeySet;"
...
.method public retainAll(Ljava/util/Collection;)Z
    ...
    .line 553
    .local v0, "changed":Z
    iget-object v1, p0, Lio/netty/util/collection/ShortObjectHashMap$KeySet;->this$0:Lio/netty/util/collection/ShortObjectHashMap;

    invoke-virtual {v1}, Lio/netty/util/collection/ShortObjectHashMap;->entries()Ljava/lang/Iterable;
    ...
    .local v1, "iter":Ljava/util/Iterator;, "Ljava/util/Iterator<Lio/netty/util/collection/ShortObjectMap$PrimitiveEntry<TV;>;>;"
    :goto_0
    ...
    .line 555
    .local v2, "entry":Lio/netty/util/collection/ShortObjectMap$PrimitiveEntry;, "Lio/netty/util/collection/ShortObjectMap$PrimitiveEntry<TV;>;"
    ...
    .line 559
    .end local v2    # "entry":Lio/netty/util/collection/ShortObjectMap$PrimitiveEntry;, "Lio/netty/util/collection/ShortObjectMap$PrimitiveEntry<TV;>;"
    :cond_0
    goto :goto_0

    .line 560
    .end local v1    # "iter":Ljava/util/Iterator;, "Ljava/util/Iterator<Lio/netty/util/collection/ShortObjectMap$PrimitiveEntry<TV;>;>;"
    :cond_1
    return v0
.end method
