...
.method public update(Lio/netty/buffer/ByteBuf;II)V
    ...
    iget v3, p0, Lio/netty/handler/codec/compression/Lz4XXHash32;->seed:I

    invoke-virtual {v0, v1, v2, p3, v3}, Lnet/jpountz/xxhash/XXHash32;->hash([BIII)I

    move-result v0

    iput v0, p0, Lio/netty/handler/codec/compression/Lz4XXHash32;->value:I
    ...
    iget v2, p0, Lio/netty/handler/codec/compression/Lz4XXHash32;->seed:I

    invoke-virtual {v0, v1, v2}, Lnet/jpountz/xxhash/XXHash32;->hash(Ljava/nio/ByteBuffer;I)I
