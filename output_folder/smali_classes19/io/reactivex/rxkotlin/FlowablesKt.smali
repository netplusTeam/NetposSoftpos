...
.method public static final withLatestFrom(Lio/reactivex/Flowable;Lorg/reactivestreams/Publisher;)Lio/reactivex/Flowable;
    .locals 2
    .param p0, "$this$withLatestFrom"    # Lio/reactivex/Flowable;
    .param p1, "other"    # Lorg/reactivestreams/Publisher;
...
.method public static final withLatestFrom(Lio/reactivex/Flowable;Lorg/reactivestreams/Publisher;Lkotlin/jvm/functions/Function2;)Lio/reactivex/Flowable;
    ...
    .param p0, "$this$withLatestFrom"    # Lio/reactivex/Flowable;
    .param p1, "other"    # Lorg/reactivestreams/Publisher;
    .param p2, "combiner"    # Lkotlin/jvm/functions/Function2;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            "Ljava/lang/Object;",
    ...
    .local v0, "$i$f$withLatestFrom":I
    const-string v1, "$this$withLatestFrom"
    ...
    .line 295
    new-instance v1, Lio/reactivex/rxkotlin/FlowablesKt$withLatestFrom$1;

    invoke-direct {v1, p2}, Lio/reactivex/rxkotlin/FlowablesKt$withLatestFrom$1;-><init>(Lkotlin/jvm/functions/Function2;)V

    check-cast v1, Lio/reactivex/functions/BiFunction;

    invoke-virtual {p0, p1, v1}, Lio/reactivex/Flowable;->withLatestFrom(Lorg/reactivestreams/Publisher;Lio/reactivex/functions/BiFunction;)Lio/reactivex/Flowable;
...
.method public static final withLatestFrom(Lio/reactivex/Flowable;Lorg/reactivestreams/Publisher;Lorg/reactivestreams/Publisher;)Lio/reactivex/Flowable;
    .locals 2
    .param p0, "$this$withLatestFrom"    # Lio/reactivex/Flowable;
    .param p1, "o1"    # Lorg/reactivestreams/Publisher;
    .param p2, "o2"    # Lorg/reactivestreams/Publisher;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            "Ljava/lang/Object;",
    ...
    const-string v1, "withLatestFrom(o1, o2, F\u20262 -> Triple(t, t1, t2) })"
...
.method public static final withLatestFrom(Lio/reactivex/Flowable;Lorg/reactivestreams/Publisher;Lorg/reactivestreams/Publisher;Lkotlin/jvm/functions/Function3;)Lio/reactivex/Flowable;
    ...
    .param p1, "o1"    # Lorg/reactivestreams/Publisher;
    .param p2, "o2"    # Lorg/reactivestreams/Publisher;
    .param p3, "combiner"    # Lkotlin/jvm/functions/Function3;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            "Ljava/lang/Object;",
    ...
    .line 314
    new-instance v1, Lio/reactivex/rxkotlin/FlowablesKt$withLatestFrom$3;

    invoke-direct {v1, p3}, Lio/reactivex/rxkotlin/FlowablesKt$withLatestFrom$3;-><init>(Lkotlin/jvm/functions/Function3;)V

    check-cast v1, Lio/reactivex/functions/Function3;

    invoke-virtual {p0, p1, p2, v1}, Lio/reactivex/Flowable;->withLatestFrom(Lorg/reactivestreams/Publisher;Lorg/reactivestreams/Publisher;Lio/reactivex/functions/Function3;)Lio/reactivex/Flowable;
...
.method public static final withLatestFrom(Lio/reactivex/Flowable;Lorg/reactivestreams/Publisher;Lorg/reactivestreams/Publisher;Lorg/reactivestreams/Publisher;Lkotlin/jvm/functions/Function4;)Lio/reactivex/Flowable;
    ...
    .param p1, "o1"    # Lorg/reactivestreams/Publisher;
    .param p2, "o2"    # Lorg/reactivestreams/Publisher;
    .param p3, "o3"    # Lorg/reactivestreams/Publisher;
    .param p4, "combiner"    # Lkotlin/jvm/functions/Function4;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            "Ljava/lang/Object;",
    ...
    .line 335
    new-instance v1, Lio/reactivex/rxkotlin/FlowablesKt$withLatestFrom$5;

    invoke-direct {v1, p4}, Lio/reactivex/rxkotlin/FlowablesKt$withLatestFrom$5;-><init>(Lkotlin/jvm/functions/Function4;)V

    check-cast v1, Lio/reactivex/functions/Function4;

    invoke-virtual {p0, p1, p2, p3, v1}, Lio/reactivex/Flowable;->withLatestFrom(Lorg/reactivestreams/Publisher;Lorg/reactivestreams/Publisher;Lorg/reactivestreams/Publisher;Lio/reactivex/functions/Function4;)Lio/reactivex/Flowable;

    move-result-object v1

    const-string v2, "withLatestFrom(o1, o2, o\u2026.invoke(t, t1, t2, t3) })"
...
.method public static final withLatestFrom(Lio/reactivex/Flowable;Lorg/reactivestreams/Publisher;Lorg/reactivestreams/Publisher;Lorg/reactivestreams/Publisher;Lorg/reactivestreams/Publisher;Lkotlin/jvm/functions/Function5;)Lio/reactivex/Flowable;
    ...
    .param p2, "o2"    # Lorg/reactivestreams/Publisher;
    .param p3, "o3"    # Lorg/reactivestreams/Publisher;
    .param p4, "o4"    # Lorg/reactivestreams/Publisher;
    .param p5, "combiner"    # Lkotlin/jvm/functions/Function5;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            "Ljava/lang/Object;",
    ...
    .line 349
    new-instance v1, Lio/reactivex/rxkotlin/FlowablesKt$withLatestFrom$6;

    invoke-direct {v1, p5}, Lio/reactivex/rxkotlin/FlowablesKt$withLatestFrom$6;-><init>(Lkotlin/jvm/functions/Function5;)V
    ...
    invoke-virtual/range {v2 .. v7}, Lio/reactivex/Flowable;->withLatestFrom(Lorg/reactivestreams/Publisher;Lorg/reactivestreams/Publisher;Lorg/reactivestreams/Publisher;Lorg/reactivestreams/Publisher;Lio/reactivex/functions/Function5;)Lio/reactivex/Flowable;

    move-result-object v1

    const-string v2, "withLatestFrom(o1, o2, o\u2026oke(t, t1, t2, t3, t4) })"
...
.method public static final zipWith(Lio/reactivex/Flowable;Lorg/reactivestreams/Publisher;)Lio/reactivex/Flowable;
    .locals 2
    .param p0, "$this$zipWith"    # Lio/reactivex/Flowable;
    .param p1, "other"    # Lorg/reactivestreams/Publisher;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static final zipWith(Lio/reactivex/Flowable;Lorg/reactivestreams/Publisher;Lkotlin/jvm/functions/Function2;)Lio/reactivex/Flowable;
    ...
    .line 360
    new-instance v1, Lio/reactivex/rxkotlin/FlowablesKt$zipWith$1;

    invoke-direct {v1, p2}, Lio/reactivex/rxkotlin/FlowablesKt$zipWith$1;-><init>(Lkotlin/jvm/functions/Function2;)V

    check-cast v1, Lio/reactivex/functions/BiFunction;

    invoke-virtual {p0, p1, v1}, Lio/reactivex/Flowable;->zipWith(Lorg/reactivestreams/Publisher;Lio/reactivex/functions/BiFunction;)Lio/reactivex/Flowable;
