...
.method public static final withLatestFrom(Lio/reactivex/Observable;Lio/reactivex/ObservableSource;)Lio/reactivex/Observable;
    .locals 2
    .param p0, "$this$withLatestFrom"    # Lio/reactivex/Observable;
    .param p1, "other"    # Lio/reactivex/ObservableSource;
...
.method public static final withLatestFrom(Lio/reactivex/Observable;Lio/reactivex/ObservableSource;Lio/reactivex/ObservableSource;)Lio/reactivex/Observable;
    .locals 2
    .param p0, "$this$withLatestFrom"    # Lio/reactivex/Observable;
    .param p1, "o1"    # Lio/reactivex/ObservableSource;
    .param p2, "o2"    # Lio/reactivex/ObservableSource;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            "Ljava/lang/Object;",
...
.method public static final withLatestFrom(Lio/reactivex/Observable;Lio/reactivex/ObservableSource;Lio/reactivex/ObservableSource;Lio/reactivex/ObservableSource;Lio/reactivex/ObservableSource;Lkotlin/jvm/functions/Function5;)Lio/reactivex/Observable;
    ...
    .param p1, "o1"    # Lio/reactivex/ObservableSource;
    .param p2, "o2"    # Lio/reactivex/ObservableSource;
    .param p3, "o3"    # Lio/reactivex/ObservableSource;
    .param p4, "o4"    # Lio/reactivex/ObservableSource;
    ...
    .line 285
    new-instance v1, Lio/reactivex/rxkotlin/ObservablesKt$withLatestFrom$6;

    invoke-direct {v1, p5}, Lio/reactivex/rxkotlin/ObservablesKt$withLatestFrom$6;-><init>(Lkotlin/jvm/functions/Function5;)V
    ...
    invoke-virtual/range {v2 .. v7}, Lio/reactivex/Observable;->withLatestFrom(Lio/reactivex/ObservableSource;Lio/reactivex/ObservableSource;Lio/reactivex/ObservableSource;Lio/reactivex/ObservableSource;Lio/reactivex/functions/Function5;)Lio/reactivex/Observable;
...
.method public static final withLatestFrom(Lio/reactivex/Observable;Lio/reactivex/ObservableSource;Lio/reactivex/ObservableSource;Lio/reactivex/ObservableSource;Lkotlin/jvm/functions/Function4;)Lio/reactivex/Observable;
    ...
    .line 271
    new-instance v1, Lio/reactivex/rxkotlin/ObservablesKt$withLatestFrom$5;

    invoke-direct {v1, p4}, Lio/reactivex/rxkotlin/ObservablesKt$withLatestFrom$5;-><init>(Lkotlin/jvm/functions/Function4;)V

    check-cast v1, Lio/reactivex/functions/Function4;

    invoke-virtual {p0, p1, p2, p3, v1}, Lio/reactivex/Observable;->withLatestFrom(Lio/reactivex/ObservableSource;Lio/reactivex/ObservableSource;Lio/reactivex/ObservableSource;Lio/reactivex/functions/Function4;)Lio/reactivex/Observable;
...
.method public static final withLatestFrom(Lio/reactivex/Observable;Lio/reactivex/ObservableSource;Lio/reactivex/ObservableSource;Lkotlin/jvm/functions/Function3;)Lio/reactivex/Observable;
    ...
    .line 252
    new-instance v1, Lio/reactivex/rxkotlin/ObservablesKt$withLatestFrom$3;

    invoke-direct {v1, p3}, Lio/reactivex/rxkotlin/ObservablesKt$withLatestFrom$3;-><init>(Lkotlin/jvm/functions/Function3;)V

    check-cast v1, Lio/reactivex/functions/Function3;

    invoke-virtual {p0, p1, p2, v1}, Lio/reactivex/Observable;->withLatestFrom(Lio/reactivex/ObservableSource;Lio/reactivex/ObservableSource;Lio/reactivex/functions/Function3;)Lio/reactivex/Observable;
...
.method public static final withLatestFrom(Lio/reactivex/Observable;Lio/reactivex/ObservableSource;Lkotlin/jvm/functions/Function2;)Lio/reactivex/Observable;
    ...
    .line 233
    new-instance v1, Lio/reactivex/rxkotlin/ObservablesKt$withLatestFrom$1;

    invoke-direct {v1, p2}, Lio/reactivex/rxkotlin/ObservablesKt$withLatestFrom$1;-><init>(Lkotlin/jvm/functions/Function2;)V

    check-cast v1, Lio/reactivex/functions/BiFunction;

    invoke-virtual {p0, p1, v1}, Lio/reactivex/Observable;->withLatestFrom(Lio/reactivex/ObservableSource;Lio/reactivex/functions/BiFunction;)Lio/reactivex/Observable;
...
.method public static final zipWith(Lio/reactivex/Observable;Lio/reactivex/ObservableSource;)Lio/reactivex/Observable;
    .locals 2
    .param p0, "$this$zipWith"    # Lio/reactivex/Observable;
    .param p1, "other"    # Lio/reactivex/ObservableSource;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static final zipWith(Lio/reactivex/Observable;Lio/reactivex/ObservableSource;Lkotlin/jvm/functions/Function2;)Lio/reactivex/Observable;
    ...
    .line 295
    new-instance v1, Lio/reactivex/rxkotlin/ObservablesKt$zipWith$1;

    invoke-direct {v1, p2}, Lio/reactivex/rxkotlin/ObservablesKt$zipWith$1;-><init>(Lkotlin/jvm/functions/Function2;)V
