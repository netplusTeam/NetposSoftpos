...
.method public static final synthetic cast(Lio/reactivex/Single;)Lio/reactivex/Single;
    .locals 3
    .param p0, "$this$cast"    # Lio/reactivex/Single;
    ...
    invoke-virtual {p0, v1}, Lio/reactivex/Single;->cast(Ljava/lang/Class;)Lio/reactivex/Single;
...
.method public static final concatAll(Ljava/lang/Iterable;)Lio/reactivex/Flowable;
    ...
    const-string v1, "Single.concat(this)"
...
.method public static final mergeAllSingles(Lio/reactivex/Flowable;)Lio/reactivex/Flowable;
    .locals 2
    .param p0, "$this$mergeAllSingles"    # Lio/reactivex/Flowable;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            "Ljava/lang/Object;",
    ...
    const-string v1, "flatMapSingle { it }"
...
.method public static final mergeAllSingles(Lio/reactivex/Observable;)Lio/reactivex/Observable;
    .locals 2
    .param p0, "$this$mergeAllSingles"    # Lio/reactivex/Observable;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            "Ljava/lang/Object;",
