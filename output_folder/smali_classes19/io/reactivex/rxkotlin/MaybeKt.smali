...
.method public static final synthetic cast(Lio/reactivex/Maybe;)Lio/reactivex/Maybe;
    .locals 3
    .param p0, "$this$cast"    # Lio/reactivex/Maybe;
    ...
    invoke-virtual {p0, v1}, Lio/reactivex/Maybe;->cast(Ljava/lang/Class;)Lio/reactivex/Maybe;
...
.method public static final concatAll(Ljava/lang/Iterable;)Lio/reactivex/Flowable;
    ...
    const-string v1, "Maybe.concat(this)"
...
.method public static final mergeAllMaybes(Lio/reactivex/Flowable;)Lio/reactivex/Flowable;
    .locals 2
    .param p0, "$this$mergeAllMaybes"    # Lio/reactivex/Flowable;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            "Ljava/lang/Object;",
    ...
    const-string v1, "flatMapMaybe { it }"
...
.method public static final mergeAllMaybes(Lio/reactivex/Observable;)Lio/reactivex/Observable;
    .locals 2
    .param p0, "$this$mergeAllMaybes"    # Lio/reactivex/Observable;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            "Ljava/lang/Object;",
...
.method public static final synthetic ofType(Lio/reactivex/Maybe;)Lio/reactivex/Maybe;
    .locals 3
    .param p0, "$this$ofType"    # Lio/reactivex/Maybe;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
            "Ljava/lang/Object;",
    ...
    invoke-virtual {p0, v1}, Lio/reactivex/Maybe;->ofType(Ljava/lang/Class;)Lio/reactivex/Maybe;
